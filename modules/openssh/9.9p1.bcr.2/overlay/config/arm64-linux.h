...
/* #undef #define HAVE_EVP_CIPHER_CTX_IV */
...
#define PACKAGE_NAME "OpenSSH Portable"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "OpenSSH Portable 9.9p1"
...
#define USER_PATH "/usr/local/sbin:/usr/local/bin:/usr/bin"
