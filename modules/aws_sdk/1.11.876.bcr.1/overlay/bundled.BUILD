...
cc_library(
    name = "kinesis",
    srcs = glob(["generated/src/aws-cpp-sdk-kinesis/source/**/*.cpp"]),
    hdrs = glob(["generated/src/aws-cpp-sdk-kinesis/include/**/*.h"]),
    copts = common_copts,
    includes = ["generated/src/aws-cpp-sdk-kinesis/include"],
    target_compatible_with = ["@platforms//os:linux"],
    visibility = ["//visibility:public"],
    deps = [":core"],
)
...
cc_library(
    name = "kms",
    srcs = glob(["generated/src/aws-cpp-sdk-kms/source/**/*.cpp"]),
    hdrs = glob(["generated/src/aws-cpp-sdk-kms/include/**/*.h"]),
    copts = common_copts,
    includes = ["generated/src/aws-cpp-sdk-kms/include"],
    target_compatible_with = ["@platforms//os:linux"],
    visibility = ["//visibility:public"],
    deps = [":core"],
)
...
cc_library(
    name = "secretsmanager",
    srcs = glob(["generated/src/aws-cpp-sdk-secretsmanager/source/**/*.cpp"]),
    hdrs = glob(["generated/src/aws-cpp-sdk-secretsmanager/include/**/*.h"]),
    copts = common_copts,
    includes = ["generated/src/aws-cpp-sdk-secretsmanager/include"],
    target_compatible_with = ["@platforms//os:linux"],
    visibility = ["//visibility:public"],
    deps = [":core"],
)
