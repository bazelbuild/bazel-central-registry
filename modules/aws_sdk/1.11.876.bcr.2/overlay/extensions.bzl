...
_SDK_ARCHIVE_PREFIX = "aws-sdk-cpp-1.11.876"

# Keep this allowlist synchronized with the source globs in bundled.BUILD.
_SDK_INCLUDES = [
    "LICENSE.txt",
    "src/aws-cpp-sdk-core/**",
    "generated/src/aws-cpp-sdk-s3/**",
    "generated/src/aws-cpp-sdk-sts/**",
    "generated/src/aws-cpp-sdk-cognito-identity/**",
    "generated/src/aws-cpp-sdk-kinesis/**",
    "generated/src/aws-cpp-sdk-kms/**",
    "generated/src/aws-cpp-sdk-secretsmanager/**",
    "src/aws-cpp-sdk-identity-management/**",
    "src/aws-cpp-sdk-transfer/**",
]

def _reproducible_metadata(ctx):
    if hasattr(ctx, "repo_metadata"):
        return ctx.repo_metadata(reproducible = True)
    return None

def _host_bsdtar_label(ctx):
...
def _aws_sdk_repository_impl(ctx):
    ...
    archive = ".aws-sdk-cpp-1.11.876.tar.gz"
    ctx.download(
    ...
    args = []
    for include in _SDK_INCLUDES:
        args.extend(["--include", _SDK_ARCHIVE_PREFIX + "/" + include])
    args.extend([
        "--strip-components",
        "1",
        "-xf",
    ...
    result = ctx.execute([ctx.path(_host_bsdtar_label(ctx))] + args)
    if result.return_code != 0:
        fail("Failed to selectively extract AWS SDK: {}\n{}".format(result.stderr, result.stdout))
    ...
    return _reproducible_metadata(ctx)
