...
SHARED_GROUP_DEFINITIONS = [
    ...
    ("shared_group_454", ["matroska_muxer", "opus_decoder", "opus_parser", "webm_muxer"]),
    ("shared_group_455", ["mlv_demuxer", "riffdec"]),
    ("shared_group_456", ["mov_muxer", "rtp_muxer", "rtpdec", "rtpenc_chain"]),
    ("shared_group_457", ["mp2_encoder", "mp2fixed_encoder"]),
    ("shared_group_458", ["mp2_encoder", "mp2fixed_encoder", "mpegaudio"]),
    ("shared_group_459", ["mp2_encoder", "mp2fixed_encoder", "mpegaudiodsp"]),
    ("shared_group_460", ["mpegvideodec", "svq3_decoder"]),
    ("shared_group_461", ["mpegvideoenc", "snow_encoder"]),
    ("shared_group_462", ["mpegvideoenc", "snow_encoder", "svq1_encoder"]),
    ("shared_group_463", ["premultiply_dynamic_filter", "premultiply_filter", "unpremultiply_filter"]),
    ("shared_group_464", ["prores_aw_encoder", "prores_decoder", "prores_encoder", "prores_ks_encoder", "prores_ks_vulkan_encoder", "prores_raw_decoder"]),
    ("shared_group_465", ["prores_decoder", "prores_raw_decoder"]),
    ("shared_group_466", ["prores_ks_encoder", "prores_ks_vulkan_encoder"]),
    ("shared_group_467", ["psnr_filter", "xpsnr_filter"]),
    ("shared_group_468", ["scale2ref_filter", "scale_cuda_filter", "scale_d3d11_filter", "scale_d3d12_filter", "scale_filter", "scale_vaapi_filter", "scale_vt_filter", "sr_amf_filter", "vpp_amf_filter"]),
    ("shared_group_469", ["srtp", "srtp_protocol", "whip_muxer"]),
    ("shared_group_470", ["webp_anim_decoder", "webp_decoder"]),
]
