...
AVCODEC_EXTRA_EXCLUSIVE_SRCS = {
    ...
    "cbs_apv": ["libavcodec/cbs_apv.c"],
    "cbs_av1": ["libavcodec/cbs_av1.c"],
    "cbs_h264": ["libavcodec/cbs_h264.c"],
    "cbs_h265": ["libavcodec/cbs_h265.c"],
    "cbs_h266": ["libavcodec/cbs_h266.c"],
    "cbs_jpeg": ["libavcodec/cbs_jpeg.c"],
    "cbs_lcevc": ["libavcodec/cbs_lcevc.c"],
    "cbs_mpeg2": ["libavcodec/cbs_mpeg2.c"],
    "cbs_vp8": ["libavcodec/cbs_vp8.c"],
    "cbs_vp9": ["libavcodec/cbs_vp9.c"],
    "celp_math": ["libavcodec/celp_math.c"],
    ...
    "hevc_sei": ["libavcodec/hevc/sei.c"],
    "hevcparse": [
    ...
    "mpegaudio": ["libavcodec/mpegaudiodec_common.c"],
    "mpegaudiodsp": [
    ...
    "mpegaudioheader": ["libavcodec/mpegaudiodecheader.c"],
    "mpegvideo": [
    ...
    "mpegvideodec": ["libavcodec/mpegvideo_dec.c"],
    "mpegvideoenc": ["libavcodec/mpegvideo_enc.c"],
    "mpegvideoencdsp": ["libavcodec/mpegvideoencdsp.c"],
    "msmpeg4dec": ["libavcodec/msmpeg4dec.c"],
    "msmpeg4enc": ["libavcodec/msmpeg4enc.c"],
    "mss34dsp": ["libavcodec/mss34dsp.c"],
    ...
    "smpte_436m": ["libavcodec/smpte_436m.c"],
...
AVCODEC_EXTRA_SHARED_SRCS = [
    (("aac_encoder", "adts_header", "flv_muxer", "matroska_demuxer", "mpeg4audio", "rtp_muxer"), ["libavcodec/mpeg4audio_sample_rates.c"]),
    (("ac3_decoder", "ac3_encoder", "ac3_fixed_decoder", "ac3_fixed_encoder", "ac3_parser", "ac3dsp"), ["libavcodec/ac3tab.c"]),
    (("ac3_decoder", "ac3_encoder", "ac3_fixed_decoder", "ac3_fixed_encoder", "ac3dsp"), ["libavcodec/ac3.c"]),
    (("acelp_kelvin_decoder", "evrc_decoder", "g729_decoder", "lsp"), ["libavcodec/lsp.c"]),
    (("agm_decoder", "lead_decoder", "mss34dsp", "nuv_decoder", "vp3_decoder"), ["libavcodec/jpegquanttables.c"]),
    (("asv1_decoder", "asv1_encoder", "asv2_decoder", "asv2_encoder", "eamad_decoder", "eatqi_decoder", "ipu_decoder", "mdec_decoder", "mpeg1video_decoder", "mpeg2video_decoder", "mpegvideo_decoder", "mpegvideo_parser", "mpegvideoenc", "speedhq_decoder", "speedhq_encoder"), ["libavcodec/mpeg12data.c"]),
    (("av1_vulkan_encoder", "d3d12va_encode", "h264_vulkan_encoder", "hevc_vulkan_encoder", "vaapi_encode"), ["libavcodec/hw_base_encode.c"]),
    (("cbs_h264", "cbs_h265", "cbs_h266", "cbs_lcevc"), ["libavcodec/cbs_h2645.c", "libavcodec/cbs_sei.c"]),
    (("cbs_vp8", "vp7_decoder", "vp8_decoder"), ["libavcodec/vp8data.c"]),
    (("deflate_wrapper", "inflate_wrapper"), ["libavcodec/zlib_wrapper.c"]),
    (("dovi_rpudec", "dovi_rpuenc"), ["libavcodec/dovi_rpu.c"]),
    (("golomb", "mxf_muxer", "rtp_muxer"), ["libavcodec/golomb.c"]),
    (("h263_decoder", "mpeg4_decoder", "mpeg4video_parser", "msmpeg4dec"), ["libavcodec/mpeg4videodec.c"]),
    (("h264_d3d12va_encoder", "h264_metadata_bsf", "h264_vaapi_encoder", "h264_vulkan_encoder", "h264parse", "hevc_d3d12va_encoder", "hevc_metadata_bsf", "hevc_vaapi_encoder", "hevc_vulkan_encoder", "hevcparse", "vvc_decoder"), ["libavcodec/h2645data.c"]),
    (("h264_decoder", "h264_parser", "h264parse", "svq3_decoder"), ["libavcodec/h264data.c"]),
    (("h264_decoder", "hevc_decoder", "vvc_sei"), ["libavcodec/h274.c"]),
    (("h264_sei", "hevc_sei", "vvc_sei"), ["libavcodec/h2645_sei.c"]),
    (("h264parse", "hevcparse"), ["libavcodec/h2645_vui.c"]),
    (("hevc_decoder", "hevcparse"), ["libavcodec/hevc/data.c"]),
    (("intrax8", "msmpeg4dec", "msmpeg4enc", "vc1_decoder"), ["libavcodec/msmpeg4_vc1_data.c"]),
    (("iso_media", "mp2_encoder", "mp2fixed_encoder", "mp3_muxer", "mpegaudioheader", "nut_muxer"), ["libavcodec/mpegaudiotabs.c"]),
    (("jpegtables", "rtp_muxer", "rtpdec"), ["libavcodec/jpegtables.c"]),
    (("mp2_encoder", "mp2fixed_encoder", "mpegaudio"), ["libavcodec/mpegaudio.c", "libavcodec/mpegaudiodata.c"]),
    (("mp2_encoder", "mp2fixed_encoder", "mpegaudiodsp"), ["libavcodec/mpegaudiodsp_data.c"]),
    (("mpegvideodec", "svq3_decoder"), ["libavcodec/mpegutils.c"]),
    (("mpegvideoenc", "snow_encoder"), ["libavcodec/ratecontrol.c"]),
    (("mpegvideoenc", "snow_encoder", "svq1_encoder"), ["libavcodec/motion_est.c"]),
    (("msmpeg4dec", "msmpeg4enc"), ["libavcodec/msmpeg4.c", "libavcodec/msmpeg4data.c"]),
]
...
AVCODEC_EXCLUSIVE_SRCS = {
    ...
    "ahx_parser": ["libavcodec/ahx_parser.c"],
    "ahx_to_mp2_bsf": ["libavcodec/bsf/ahx_to_mp2.c"],
    ...
    "apv_metadata_bsf": ["libavcodec/bsf/apv_metadata.c"],
    "apv_parser": ["libavcodec/apv_parser.c"],
    "apv_vulkan_hwaccel": ["libavcodec/vulkan_apv.c"],
    ...
    "av1_d3d12va_encoder": ["libavcodec/d3d12va_encode_av1.c"],
    ...
    "av1_vaapi_encoder": ["libavcodec/vaapi_encode_av1.c"],
    "av1_vaapi_hwaccel": ["libavcodec/vaapi_av1.c"],
    "av1_vdpau_hwaccel": ["libavcodec/vdpau_av1.c"],
    "av1_videotoolbox_hwaccel": ["libavcodec/videotoolbox_av1.c"],
    "av1_vulkan_encoder": ["libavcodec/vulkan_encode_av1.c"],
    ...
    "eia608_to_smpte436m_bsf": ["libavcodec/bsf/eia608_to_smpte436m.c"],
    ...
    "ffv1_parser": ["libavcodec/ffv1_parser.c"],
    "ffv1_vulkan_encoder": ["libavcodec/ffv1enc_vulkan.c"],
    "ffv1_vulkan_hwaccel": ["libavcodec/vulkan_ffv1.c"],
    ...
    "g728_decoder": ["libavcodec/g728dec.c"],
    ...
    "jpegxl_parser": ["libavcodec/jpegxl_parser.c"],
    "jpegxs_parser": ["libavcodec/jpegxs_parser.c"],
    ...
    "lcevc_metadata_bsf": ["libavcodec/bsf/lcevc_metadata.c"],
    "lcevc_parser": ["libavcodec/lcevc_parser.c"],
    ...
    "libmpeghdec_decoder": ["libavcodec/libmpeghdec.c"],
    "liboapv_encoder": ["libavcodec/liboapvenc.c"],
    ...
    "libsvtjpegxs_decoder": ["libavcodec/libsvtjpegxsdec.c"],
    "libsvtjpegxs_encoder": ["libavcodec/libsvtjpegxsenc.c"],
    ...
    "pdv_encoder": ["libavcodec/pdvenc.c"],
    ...
    "prores_decoder": ["libavcodec/proresdec.c"],
    "prores_ks_encoder": ["libavcodec/proresenc_kostya.c"],
    "prores_ks_vulkan_encoder": ["libavcodec/proresenc_kostya_vulkan.c"],
    "prores_metadata_bsf": ["libavcodec/bsf/prores_metadata.c"],
    "prores_parser": ["libavcodec/prores_parser.c"],
    "prores_raw_decoder": ["libavcodec/prores_raw.c"],
    "prores_raw_parser": ["libavcodec/prores_raw_parser.c"],
    "prores_raw_vulkan_hwaccel": ["libavcodec/vulkan_prores_raw.c"],
    "prores_vulkan_hwaccel": ["libavcodec/vulkan_prores.c"],
    ...
    "sbc_decoder": ["libavcodec/sbcdec.c"],
    "sbc_encoder": [
        "libavcodec/sbcdsp.c",
        "libavcodec/sbcenc.c",
    ],
    ...
    "smpte436m_to_eia608_bsf": ["libavcodec/bsf/smpte436m_to_eia608.c"],
    ...
    "vp9_vulkan_hwaccel": ["libavcodec/vulkan_vp9.c"],
    ...
    "vvc_vaapi_hwaccel": ["libavcodec/vaapi_vvc.c"],
...
AVCODEC_SHARED_SRCS = [
    ...
    (("aac_decoder", "aac_fixed_decoder"), ["libavcodec/aac/aacdec.c", "libavcodec/aac/aacdec_tab.c", "libavcodec/aacps_common.c", "libavcodec/cbrt_tablegen_common.c"]),
    ...
    (("ac3_decoder", "ac3_fixed_decoder", "ac3_parser", "hls_demuxer", "mov_demuxer"), ["libavcodec/ac3_channel_layout_tab.c"]),
    (("ac3_encoder", "ac3_fixed_encoder"), ["libavcodec/ac3enc.c"]),
    (("acelp_kelvin_decoder", "amrnb_decoder", "amrwb_decoder", "comfortnoise_decoder", "g723_1_decoder", "g723_1_encoder", "g728_decoder", "g729_decoder", "qcelp_decoder", "ra_144_decoder", "ra_144_encoder", "ra_288_decoder", "sipr_decoder", "wmavoice_decoder"), ["libavcodec/celp_filters.c"]),
    ...
    (("ahx_decoder", "mp1float_decoder", "mp2float_decoder", "mp3adufloat_decoder", "mp3float_decoder", "mp3on4float_decoder"), ["libavcodec/mpegaudiodec_float.c"]),
    ...
    (("apv_vulkan_hwaccel", "av1_vulkan_hwaccel", "dpx_vulkan_hwaccel", "ffv1_vulkan_hwaccel", "h264_vulkan_hwaccel", "hevc_vulkan_hwaccel", "prores_raw_vulkan_hwaccel", "prores_vulkan_hwaccel", "vp9_vulkan_hwaccel"), ["libavcodec/vulkan_decode.c"]),
    ...
    (("av1_amf_decoder", "h264_amf_decoder", "hevc_amf_decoder", "vp9_amf_decoder"), ["libavcodec/amfdec.c"]),
    ...
    (("av1_d3d12va_encoder", "av1_vaapi_encoder", "av1_vulkan_encoder"), ["libavcodec/av1_levels.c"]),
    ...
    (("dca_decoder", "dca_parser"), ["libavcodec/dca.c", "libavcodec/dca_exss.c"]),
    (("dca_decoder", "dca_parser", "spdif_muxer"), ["libavcodec/dca_sample_rate_tab.c"]),
    ...
    (("eamad_decoder", "eatqi_decoder", "ipu_decoder", "mdec_decoder", "mpeg1video_decoder", "mpeg2video_decoder", "mpegvideo_decoder", "speedhq_decoder"), ["libavcodec/mpeg12.c"]),
    (("eightsvx_exp_decoder", "eightsvx_fib_decoder"), ["libavcodec/8svx.c"]),
    (("ffv1_decoder", "ffv1_encoder", "ffv1_parser"), ["libavcodec/ffv1_parse.c"]),
    (("ffv1_decoder", "ffv1_encoder", "ffv1_parser", "ffv1_vulkan_encoder"), ["libavcodec/ffv1.c"]),
    (("ffv1_encoder", "ffv1_vulkan_encoder"), ["libavcodec/ffv1enc.c"]),
    (("ffv1_vulkan_encoder", "ffv1_vulkan_hwaccel"), ["libavcodec/ffv1_vulkan.c"]),
    ...
    (("h263_decoder", "h263_encoder", "mpeg4video_parser", "svq1_encoder"), ["libavcodec/h263.c"]),
    (("h263_decoder", "mpeg4video_parser"), ["libavcodec/ituh263dec.c"]),
    ...
    (("h264_d3d12va_encoder", "h264_metadata_bsf", "h264_vaapi_encoder", "h264_vulkan_encoder"), ["libavcodec/h264_levels.c"]),
    (("h264_d3d12va_encoder", "h264_vaapi_encoder", "h264_vulkan_encoder"), ["libavcodec/hw_base_encode_h264.c"]),
    (("h264_mmal_decoder", "mpeg2_mmal_decoder", "vc1_mmal_decoder"), ["libavcodec/mmaldec.c"]),
    (("h264_oh_decoder", "h264_oh_encoder", "hevc_oh_decoder", "hevc_oh_encoder"), ["libavcodec/ohcodec.c"]),
    (("h264_oh_decoder", "hevc_oh_decoder"), ["libavcodec/ohdec.c"]),
    (("h264_oh_encoder", "hevc_oh_encoder"), ["libavcodec/ohenc.c"]),
    (("h264_rkmpp_decoder", "hevc_rkmpp_decoder", "vp8_rkmpp_decoder", "vp9_rkmpp_decoder"), ["libavcodec/rkmppdec.c"]),
    (("h264_rkmpp_encoder", "hevc_rkmpp_encoder"), ["libavcodec/rkmppenc.c"]),
    ...
    (("hevc_d3d12va_encoder", "hevc_vaapi_encoder", "hevc_vulkan_encoder"), ["libavcodec/hw_base_encode_h265.c"]),
    (("hq_hqa_decoder", "hqx_decoder"), ["libavcodec/hq_common.c"]),
    (("huffyuv_decoder", "huffyuv_encoder", "hymt_decoder"), ["libavcodec/huffyuv.c"]),
    (("huffyuv_decoder", "hymt_decoder"), ["libavcodec/huffyuvdec.c"]),
    (("image_jpegxl_pipe_demuxer", "jpegxl_anim_demuxer", "jpegxl_parser"), ["libavcodec/jpegxl_parse.c"]),
    ...
    (("matroska_muxer", "opus_decoder", "opus_parser", "webm_muxer"), ["libavcodec/opus/frame_duration_tab.c"]),
    ...
    (("mp2_encoder", "mp2fixed_encoder"), ["libavcodec/mpegaudioenc.c"]),
    ...
    (("prores_aw_encoder", "prores_decoder", "prores_encoder", "prores_ks_encoder", "prores_ks_vulkan_encoder", "prores_raw_decoder"), ["libavcodec/proresdata.c"]),
    (("prores_aw_encoder", "prores_encoder"), ["libavcodec/proresenc_anatoliy.c"]),
    (("prores_decoder", "prores_raw_decoder"), ["libavcodec/proresdsp.c"]),
    (("prores_ks_encoder", "prores_ks_vulkan_encoder"), ["libavcodec/proresenc_kostya_common.c"]),
    ...
    (("webp_anim_decoder", "webp_decoder"), ["libavcodec/webp.c"]),
...
AVCODEC_AARCH64_SHARED_SRCS = [
    ...
    (("hevc_decoder", "vvc_decoder"), ["libavcodec/aarch64/h26x/epel_neon.S", "libavcodec/aarch64/h26x/qpel_neon.S", "libavcodec/aarch64/h26x/sao_neon.S"]),
]
...
AVCODEC_X86_EXCLUSIVE_SRCS = {
    ...
    "apv_decoder": ["libavcodec/x86/apv_dsp_init.c"],
    ...
    "mpegvideoenc": ["libavcodec/x86/mpegvideoenc.c"],
    "mpegvideoencdsp": ["libavcodec/x86/mpegvideoencdsp_init.c"],
...
AVCODEC_X86_SHARED_SRCS = [
    ...
    (("prores_decoder", "prores_raw_decoder"), ["libavcodec/x86/proresdsp_init.c"]),
    (("snow_decoder", "snow_encoder"), ["libavcodec/x86/snowdsp_init.c"]),
]
...
AVCODEC_X86_ASM_EXCLUSIVE_SRCS = {
    ...
    "apv_decoder": ["libavcodec/x86/apv_dsp.asm"],
    ...
    "mpegvideoencdsp": ["libavcodec/x86/mpegvideoencdsp.asm"],
...
AVCODEC_X86_ASM_SHARED_SRCS = [
    ...
    (("h264qpel", "hpeldsp", "qpeldsp", "vc1dsp"), ["libavcodec/x86/fpel.asm"]),
    ...
    (("prores_decoder", "prores_raw_decoder"), ["libavcodec/x86/proresdsp.asm"]),
    (("snow_decoder", "snow_encoder"), ["libavcodec/x86/snowdsp.asm"]),
]

AVCODEC_X86_ASM_EXCLUSIVE_SRCS_BY_DIR = {
    "libavcodec/x86": {
        "aac_decoder": [
            "libavcodec/x86/aacpsdsp.asm",
            "libavcodec/x86/sbrdsp.asm",
...
AVCODEC_X86_ASM_SHARED_SRCS_BY_DIR = {
    "libavcodec/x86": [
        (("adpcm_g722_decoder", "adpcm_g722_encoder"), ["libavcodec/x86/g722dsp.asm"]),
        (("apng_decoder", "lscr_decoder", "png_decoder"), ["libavcodec/x86/pngdsp.asm"]),
        (("h264qpel", "hpeldsp", "qpeldsp", "vc1dsp"), ["libavcodec/x86/fpel.asm"]),
...
AVFORMAT_EXTRA_EXCLUSIVE_SRCS = {
    "cbs_apv_lavf": ["libavformat/cbs_apv.c"],
    "cbs_av1_lavf": ["libavformat/cbs_av1.c"],
    "iamfdec": [
...
AVFORMAT_EXTRA_SHARED_SRCS = [
    (("cbs_apv_lavf", "cbs_av1_lavf"), ["libavformat/cbs.c"]),
    (("iamfdec", "iamfenc"), ["libavformat/iamf.c"]),
    (("iso_writer", "whip_muxer"), ["libavformat/avc.c"]),
    (("mlv_demuxer", "riffdec"), ["libavformat/riffdec.c"]),
    (("mov_muxer", "rtp_muxer", "rtpdec", "rtpenc_chain"), ["libavformat/rtp.c"]),
    (("srtp", "srtp_protocol", "whip_muxer"), ["libavformat/srtp.c"]),
]
...
AVFORMAT_EXCLUSIVE_SRCS = {
    ...
    "apv_demuxer": ["libavformat/apvdec.c"],
    "apv_muxer": ["libavformat/apvenc.c"],
    ...
    "dvdvideo_demuxer": ["libavformat/dvdvideodec.c"],
    ...
    "g728_demuxer": ["libavformat/g728dec.c"],
    ...
    "hxvs_demuxer": ["libavformat/hxvs.c"],
    ...
    "mcc_muxer": ["libavformat/mccenc.c"],
    ...
    "pdv_muxer": ["libavformat/pdvenc.c"],
    ...
    "shared_protocol": ["libavformat/shared.c"],
...
AVFORMAT_SHARED_SRCS = [
    ...
    (("dvdvideo_demuxer", "mov_demuxer"), ["libavformat/dvdclut.c"]),
    ...
    (("http_protocol", "httpproxy_protocol", "https_protocol", "whip_muxer"), ["libavformat/http.c"]),
...
AVFORMAT_AARCH64_COMPONENT_SRCS = []

AVFORMAT_AARCH64_EXCLUSIVE_SRCS = {
}

AVFORMAT_AARCH64_SHARED_SRCS = [
]

AVFORMAT_X86_COMPONENT_SRCS = []

AVFORMAT_X86_EXCLUSIVE_SRCS = {
}

AVFORMAT_X86_SHARED_SRCS = [
]

AVFORMAT_X86_ASM_EXCLUSIVE_SRCS = {
}

AVFORMAT_X86_ASM_SHARED_SRCS = [
]

AVFILTER_EXTRA_SRCS = []

AVFILTER_EXTRA_EXCLUSIVE_SRCS = {
    "dnn": [
...
AVFILTER_EXCLUSIVE_SRCS = {
    ...
    "amf_capture_filter": ["libavfilter/vsrc_amf.c"],
    ...
    "blackdetect_vulkan_filter": ["libavfilter/vf_blackdetect_vulkan.c"],
    ...
    "colordetect_filter": ["libavfilter/vf_colordetect.c"],
    ...
    "deinterlace_d3d12_filter": ["libavfilter/vf_deinterlace_d3d12.c"],
    ...
    "drawvg_filter": ["libavfilter/vf_drawvg.c"],
    ...
    "frc_amf_filter": ["libavfilter/vf_frc_amf.c"],
    ...
    "gfxcapture_filter": ["libavfilter/vsrc_gfxcapture.c"],
    ...
    "interlace_vulkan_filter": ["libavfilter/vf_interlace_vulkan.c"],
    ...
    "mestimate_d3d12_filter": ["libavfilter/vf_mestimate_d3d12.c"],
    ...
    "ocio_filter": ["libavfilter/vf_opencolorio.c"],
    ...
    "pad_cuda_filter": ["libavfilter/vf_pad_cuda.c"],
    ...
    "scale_d3d11_filter": ["libavfilter/vf_scale_d3d11.c"],
    "scale_d3d12_filter": ["libavfilter/vf_scale_d3d12.c"],
    ...
    "scdet_vulkan_filter": ["libavfilter/vf_scdet_vulkan.c"],
    ...
    "sr_amf_filter": ["libavfilter/vf_sr_amf.c"],
    ...
    "transpose_cuda_filter": ["libavfilter/vf_transpose_cuda.c"],
    ...
    "v360_vulkan_filter": ["libavfilter/vf_v360_vulkan.c"],
    ...
    "vpp_amf_filter": ["libavfilter/vf_vpp_amf.c"],
    "w3fdif_filter": ["libavfilter/vf_w3fdif.c"],
    "waveform_filter": ["libavfilter/vf_waveform.c"],
    "whisper_filter": ["libavfilter/af_whisper.c"],
...
AVFILTER_SHARED_SRCS = [
    ...
    (("alphamerge_filter", "astreamselect_filter", "blend_filter", "blend_vulkan_filter", "bm3d_filter", "colormap_filter", "convolve_filter", "corr_filter", "deconvolve_filter", "displace_filter", "guided_filter", "haldclut_filter", "hstack_filter", "hstack_qsv_filter", "hstack_vaapi_filter", "hysteresis_filter", "identity_filter", "libvmaf_cuda_filter", "libvmaf_filter", "limitdiff_filter", "lut2_filter", "lut3d_filter", "maskedclamp_filter", "maskedmax_filter", "maskedmerge_filter", "maskedmin_filter", "maskedthreshold_filter", "mergeplanes_filter", "midequalizer_filter", "mix_filter", "morpho_filter", "msad_filter", "multiply_filter", "overlay_cuda_filter", "overlay_filter", "overlay_opencl_filter", "overlay_qsv_filter", "overlay_vaapi_filter", "paletteuse_filter", "premultiply_dynamic_filter", "premultiply_filter", "program_opencl_filter", "psnr_filter", "remap_filter", "remap_opencl_filter", "scale2ref_filter", "scale_filter", "ssim360_filter", "ssim_filter", "streamselect_filter", "tblend_filter", "threshold_filter", "tlut2_filter", "tmedian_filter", "tmix_filter", "unpremultiply_filter", "varblur_filter", "vif_filter", "vmafmotion_filter", "vstack_filter", "vstack_qsv_filter", "vstack_vaapi_filter", "xcorrelate_filter", "xmedian_filter", "xpsnr_filter", "xstack_filter", "xstack_qsv_filter", "xstack_vaapi_filter"), ["libavfilter/framesync.c"]),
    ...
    (("avgblur_vulkan_filter", "blend_vulkan_filter", "bwdif_vulkan_filter", "chromaber_vulkan_filter", "color_vulkan_filter", "gblur_vulkan_filter", "hflip_vulkan_filter", "interlace_vulkan_filter", "libplacebo_filter", "nlmeans_vulkan_filter", "overlay_vulkan_filter", "scale_vulkan_filter", "transpose_vulkan_filter", "vflip_vulkan_filter", "xfade_vulkan_filter"), ["libavfilter/vulkan.c"]),
    (("avgblur_vulkan_filter", "blend_vulkan_filter", "bwdif_vulkan_filter", "chromaber_vulkan_filter", "color_vulkan_filter", "gblur_vulkan_filter", "interlace_vulkan_filter", "libplacebo_filter", "nlmeans_vulkan_filter", "overlay_vulkan_filter", "scale_vulkan_filter", "transpose_vulkan_filter", "xfade_vulkan_filter"), ["libavfilter/vulkan_filter.c"]),
    ...
    (("codecview_filter", "fspp_filter", "pp7_filter", "spp_filter", "uspp_filter"), ["libavfilter/qp_table.c"]),
    (("colorhold_filter", "colorkey_filter"), ["libavfilter/vf_colorkey.c"]),
    (("colorspace_cuda_filter", "overlay_cuda_filter", "pad_cuda_filter", "scale_cuda_filter", "thumbnail_cuda_filter", "transpose_cuda_filter", "yadif_cuda_filter"), ["libavfilter/cuda/load_helper.c"]),
    ...
    (("drawtext_filter", "drawvg_filter", "qrencode_filter", "qrencodesrc_filter"), ["libavfilter/textutils.c"]),
    (("format_filter", "noformat_filter"), ["libavfilter/vf_format.c"]),
    (("frc_amf_filter", "sr_amf_filter", "vpp_amf_filter"), ["libavfilter/vf_amf_common.c"]),
    ...
    (("identity_filter", "msad_filter"), ["libavfilter/vf_identity.c"]),
    ...
    (("premultiply_dynamic_filter", "premultiply_filter", "unpremultiply_filter"), ["libavfilter/vf_premultiply.c"]),
    (("psnr_filter", "xpsnr_filter"), ["libavfilter/psnr.c"]),
    (("qrencode_filter", "qrencodesrc_filter"), ["libavfilter/qrencode.c"]),
    (("removelogo_filter", "showcqt_filter"), ["libavfilter/lswsutils.c"]),
    (("scale2ref_filter", "scale_cuda_filter", "scale_d3d11_filter", "scale_d3d12_filter", "scale_filter", "scale_vaapi_filter", "scale_vt_filter", "sr_amf_filter", "vpp_amf_filter"), ["libavfilter/scale_eval.c"]),
...
AVFILTER_X86_EXCLUSIVE_SRCS = {
    ...
    "blackdetect_filter": ["libavfilter/x86/vf_blackdetect_init.c"],
    "bwdif_filter": ["libavfilter/x86/vf_bwdif_init.c"],
    "colordetect_filter": ["libavfilter/x86/vf_colordetect_init.c"],
    "colorspace_filter": ["libavfilter/x86/colorspacedsp_init.c"],
    "ebur128_filter": ["libavfilter/x86/f_ebur128_init.c"],
    ...
    "idet_filter": ["libavfilter/x86/vf_idetdsp_init.c"],
...
AVFILTER_X86_SHARED_SRCS = [
    ...
    (("psnr_filter", "xpsnr_filter"), ["libavfilter/x86/vf_psnr_init.c"]),
]
...
AVFILTER_X86_ASM_EXCLUSIVE_SRCS = {
    ...
    "blackdetect_filter": ["libavfilter/x86/vf_blackdetect.asm"],
    "bwdif_filter": ["libavfilter/x86/vf_bwdif.asm"],
    "colordetect_filter": ["libavfilter/x86/vf_colordetect.asm"],
    "colorspace_filter": ["libavfilter/x86/colorspacedsp.asm"],
    "ebur128_filter": ["libavfilter/x86/f_ebur128.asm"],
    ...
    "idet_filter": ["libavfilter/x86/vf_idetdsp.asm"],
...
AVFILTER_X86_ASM_SHARED_SRCS = [
    ...
    (("psnr_filter", "xpsnr_filter"), ["libavfilter/x86/vf_psnr.asm"]),
]

AVDEVICE_EXTRA_SRCS = []

AVDEVICE_EXTRA_EXCLUSIVE_SRCS = {
}

AVDEVICE_EXTRA_SHARED_SRCS = [
]
...
AVDEVICE_AARCH64_COMPONENT_SRCS = []

AVDEVICE_AARCH64_EXCLUSIVE_SRCS = {
}

AVDEVICE_AARCH64_SHARED_SRCS = [
]

AVDEVICE_X86_COMPONENT_SRCS = []

AVDEVICE_X86_EXCLUSIVE_SRCS = {
}

AVDEVICE_X86_SHARED_SRCS = [
]

AVDEVICE_X86_ASM_EXCLUSIVE_SRCS = {
}

AVDEVICE_X86_ASM_SHARED_SRCS = [
]

SHARED_GROUP_DEFINITIONS = [
    ("shared_group_1", ["aac_encoder", "adts_header", "flv_muxer", "matroska_demuxer", "mpeg4audio", "rtp_muxer"]),
    ("shared_group_10", ["deflate_wrapper", "inflate_wrapper"]),
    ("shared_group_100", ["dvvideo_decoder", "dvvideo_encoder"]),
    ("shared_group_101", ["eac3_decoder", "eac3_encoder"]),
    ("shared_group_102", ["eamad_decoder", "eatgq_decoder", "eatqi_decoder"]),
    ("shared_group_103", ["eamad_decoder", "eatqi_decoder", "ipu_decoder", "mdec_decoder", "mpeg1video_decoder", "mpeg2video_decoder", "mpegvideo_decoder", "speedhq_decoder"]),
    ("shared_group_104", ["eightsvx_exp_decoder", "eightsvx_fib_decoder"]),
    ("shared_group_105", ["ffv1_decoder", "ffv1_encoder", "ffv1_parser"]),
    ("shared_group_106", ["ffv1_decoder", "ffv1_encoder", "ffv1_parser", "ffv1_vulkan_encoder"]),
    ("shared_group_107", ["ffv1_encoder", "ffv1_vulkan_encoder"]),
    ("shared_group_108", ["ffv1_vulkan_encoder", "ffv1_vulkan_hwaccel"]),
    ("shared_group_109", ["fits_decoder", "fits_demuxer"]),
    ("shared_group_11", ["dovi_rpudec", "dovi_rpuenc"]),
    ("shared_group_110", ["flac_decoder", "flac_encoder", "flac_parser"]),
    ("shared_group_111", ["flac_decoder", "flac_parser"]),
    ("shared_group_112", ["flashsv2_decoder", "flashsv_decoder"]),
    ("shared_group_113", ["g2m_decoder", "mjpeg_decoder"]),
    ("shared_group_114", ["g723_1_decoder", "g723_1_encoder"]),
    ("shared_group_115", ["gif_decoder", "tiff_decoder"]),
    ("shared_group_116", ["gif_encoder", "tiff_encoder"]),
    ("shared_group_117", ["gsm_decoder", "gsm_ms_decoder"]),
    ("shared_group_118", ["h261_decoder", "h261_encoder"]),
    ("shared_group_119", ["h263_decoder", "h263_encoder", "mpeg4video_parser"]),
    ("shared_group_12", ["golomb", "mxf_muxer", "rtp_muxer"]),
    ("shared_group_120", ["h263_decoder", "h263_encoder", "mpeg4video_parser", "snow_encoder", "svq1_decoder", "svq1_encoder"]),
    ("shared_group_121", ["h263_decoder", "h263_encoder", "mpeg4video_parser", "svq1_encoder"]),
    ("shared_group_122", ["h263_decoder", "mpeg4video_parser"]),
    ("shared_group_123", ["h263_encoder", "snow_encoder", "svq1_encoder"]),
    ("shared_group_124", ["h263_v4l2m2m_decoder", "h264_v4l2m2m_decoder", "hevc_v4l2m2m_decoder", "mpeg1_v4l2m2m_decoder", "mpeg2_v4l2m2m_decoder", "mpeg4_v4l2m2m_decoder", "vc1_v4l2m2m_decoder", "vp8_v4l2m2m_decoder", "vp9_v4l2m2m_decoder"]),
    ("shared_group_125", ["h263_v4l2m2m_encoder", "h264_v4l2m2m_encoder", "hevc_v4l2m2m_encoder", "mpeg4_v4l2m2m_encoder", "vp8_v4l2m2m_encoder"]),
    ("shared_group_126", ["h263_vaapi_hwaccel", "mpeg4_vaapi_hwaccel"]),
    ("shared_group_127", ["h263_videotoolbox_hwaccel", "h264_videotoolbox_hwaccel", "mpeg1_videotoolbox_hwaccel", "mpeg2_videotoolbox_hwaccel", "mpeg4_videotoolbox_hwaccel"]),
    ("shared_group_128", ["h264_d3d11va_hwaccel", "h264_d3d12va_hwaccel", "h264_dxva2_hwaccel"]),
    ("shared_group_129", ["h264_d3d12va_encoder", "h264_metadata_bsf", "h264_vaapi_encoder", "h264_vulkan_encoder"]),
    ("shared_group_13", ["h263_decoder", "mpeg4_decoder", "mpeg4video_parser", "msmpeg4dec"]),
    ("shared_group_130", ["h264_d3d12va_encoder", "h264_vaapi_encoder", "h264_vulkan_encoder"]),
    ("shared_group_131", ["h264_mmal_decoder", "mpeg2_mmal_decoder", "vc1_mmal_decoder"]),
    ("shared_group_132", ["h264_oh_decoder", "h264_oh_encoder", "hevc_oh_decoder", "hevc_oh_encoder"]),
    ("shared_group_133", ["h264_oh_decoder", "hevc_oh_decoder"]),
    ("shared_group_134", ["h264_oh_encoder", "hevc_oh_encoder"]),
    ("shared_group_135", ["h264_rkmpp_decoder", "hevc_rkmpp_decoder", "vp8_rkmpp_decoder", "vp9_rkmpp_decoder"]),
    ("shared_group_136", ["h264_rkmpp_encoder", "hevc_rkmpp_encoder"]),
    ("shared_group_137", ["h264_videotoolbox_encoder", "hevc_videotoolbox_encoder", "prores_videotoolbox_encoder"]),
    ("shared_group_138", ["hap_decoder", "hap_encoder", "hapqa_extract_bsf"]),
    ("shared_group_139", ["hevc_d3d11va_hwaccel", "hevc_d3d12va_hwaccel", "hevc_dxva2_hwaccel"]),
    ("shared_group_14", ["h264_d3d12va_encoder", "h264_metadata_bsf", "h264_vaapi_encoder", "h264_vulkan_encoder", "h264parse", "hevc_d3d12va_encoder", "hevc_metadata_bsf", "hevc_vaapi_encoder", "hevc_vulkan_encoder", "hevcparse", "vvc_decoder"]),
    ("shared_group_140", ["hevc_d3d12va_encoder", "hevc_metadata_bsf", "hevc_vaapi_encoder", "hevc_vaapi_hwaccel", "hevc_vdpau_hwaccel", "hevc_vulkan_encoder"]),
    ("shared_group_141", ["hevc_d3d12va_encoder", "hevc_vaapi_encoder", "hevc_vulkan_encoder"]),
    ("shared_group_142", ["hq_hqa_decoder", "hqx_decoder"]),
    ("shared_group_143", ["huffyuv_decoder", "huffyuv_encoder", "hymt_decoder"]),
    ("shared_group_144", ["huffyuv_decoder", "hymt_decoder"]),
    ("shared_group_145", ["image_jpegxl_pipe_demuxer", "jpegxl_anim_demuxer", "jpegxl_parser"]),
    ("shared_group_146", ["indeo4_decoder", "indeo5_decoder"]),
    ("shared_group_147", ["ipu_decoder", "mpeg1video_decoder", "mpeg2video_decoder", "mpegvideo_decoder"]),
    ("shared_group_148", ["jpeg2000_decoder", "jpeg2000_encoder"]),
    ("shared_group_149", ["jpegls_decoder", "jpegls_encoder"]),
    ("shared_group_15", ["h264_decoder", "h264_parser", "h264parse", "svq3_decoder"]),
    ("shared_group_150", ["libaom_av1_decoder", "libaom_av1_encoder"]),
    ("shared_group_151", ["libcodec2_decoder", "libcodec2_encoder"]),
    ("shared_group_152", ["libgsm_decoder", "libgsm_ms_decoder"]),
    ("shared_group_153", ["libgsm_encoder", "libgsm_ms_encoder"]),
    ("shared_group_154", ["libilbc_decoder", "libilbc_encoder"]),
    ("shared_group_155", ["libjxl_decoder", "libjxl_encoder"]),
    ("shared_group_156", ["libopencore_amrnb_decoder", "libopencore_amrnb_encoder", "libopencore_amrwb_decoder"]),
    ("shared_group_157", ["libopenh264_decoder", "libopenh264_encoder"]),
    ("shared_group_158", ["libopus_decoder", "libopus_encoder"]),
    ("shared_group_159", ["libopus_decoder", "libopus_encoder", "libvorbis_encoder", "opus_decoder", "opus_parser", "vorbis_decoder", "vorbis_encoder"]),
    ("shared_group_16", ["h264_decoder", "hevc_decoder", "vvc_sei"]),
    ("shared_group_160", ["libvpx_vp8_decoder", "libvpx_vp9_decoder"]),
    ("shared_group_161", ["libvpx_vp8_encoder", "libvpx_vp9_encoder"]),
    ("shared_group_162", ["libwebp_anim_encoder", "libwebp_encoder"]),
    ("shared_group_163", ["libx262_encoder", "libx264_encoder"]),
    ("shared_group_164", ["mace3_decoder", "mace6_decoder"]),
    ("shared_group_165", ["matroska_muxer", "opus_decoder", "opus_parser", "webm_muxer"]),
    ("shared_group_166", ["media100_decoder", "mjpegb_decoder"]),
    ("shared_group_167", ["metasound_decoder", "twinvq_decoder"]),
    ("shared_group_168", ["mlp_decoder", "truehd_decoder"]),
    ("shared_group_169", ["mlp_encoder", "mlp_parser", "truehd_core_bsf", "truehd_encoder"]),
    ("shared_group_17", ["h264_sei", "hevc_sei", "vvc_sei"]),
    ("shared_group_170", ["mlp_encoder", "truehd_encoder"]),
    ("shared_group_171", ["mlp_parser", "truehd_core_bsf"]),
    ("shared_group_172", ["mov2textsub_bsf", "text2movsub_bsf"]),
    ("shared_group_173", ["movtext_encoder", "srt_encoder", "subrip_encoder", "text_encoder", "ttml_encoder", "webvtt_encoder"]),
    ("shared_group_174", ["mp1_decoder", "mp2_decoder", "mp3_decoder", "mp3adu_decoder", "mp3on4_decoder"]),
    ("shared_group_175", ["mp2_encoder", "mp2fixed_encoder"]),
    ("shared_group_176", ["mpc7_decoder", "mpc8_decoder"]),
    ("shared_group_177", ["mpeg1_nvdec_hwaccel", "mpeg2_nvdec_hwaccel"]),
    ("shared_group_178", ["mpeg1_vdpau_hwaccel", "mpeg2_vdpau_hwaccel"]),
    ("shared_group_179", ["mpeg1video_encoder", "mpeg2video_encoder", "speedhq_encoder"]),
    ("shared_group_18", ["h264parse", "hevcparse"]),
    ("shared_group_180", ["mpeg2_d3d11va_hwaccel", "mpeg2_d3d12va_hwaccel", "mpeg2_dxva2_hwaccel"]),
    ("shared_group_181", ["mscc_decoder", "srgc_decoder"]),
    ("shared_group_182", ["msnsiren_decoder", "siren_decoder"]),
    ("shared_group_183", ["mss1_decoder", "mss2_decoder"]),
    ("shared_group_184", ["mss2_decoder", "vc1_decoder", "vc1_parser", "wmv2_decoder", "wmv2_encoder"]),
    ("shared_group_185", ["mszh_decoder", "zlib_decoder"]),
    ("shared_group_186", ["mvc1_decoder", "mvc2_decoder"]),
    ("shared_group_187", ["nellymoser_decoder", "nellymoser_encoder"]),
    ("shared_group_188", ["opus_decoder", "opus_encoder"]),
    ("shared_group_189", ["opus_decoder", "opus_parser"]),
    ("shared_group_19", ["hevc_decoder", "hevcparse"]),
    ("shared_group_190", ["pam_decoder", "pbm_decoder", "pfm_decoder", "pgm_decoder", "pgmyuv_decoder", "phm_decoder", "pnm_parser", "ppm_decoder"]),
    ("shared_group_191", ["pam_decoder", "pbm_decoder", "pfm_decoder", "pgm_decoder", "pgmyuv_decoder", "phm_decoder", "ppm_decoder"]),
    ("shared_group_192", ["pbm_encoder", "pfm_encoder", "pgm_encoder", "pgmyuv_encoder", "phm_encoder", "ppm_encoder"]),
    ("shared_group_193", ["pcm_alaw_decoder", "pcm_alaw_encoder", "pcm_f16le_decoder", "pcm_f24le_decoder", "pcm_f32be_decoder", "pcm_f32be_encoder", "pcm_f32le_decoder", "pcm_f32le_encoder", "pcm_f64be_decoder", "pcm_f64be_encoder", "pcm_f64le_decoder", "pcm_f64le_encoder", "pcm_lxf_decoder", "pcm_mulaw_decoder", "pcm_mulaw_encoder", "pcm_s16be_decoder", "pcm_s16be_encoder", "pcm_s16be_planar_decoder", "pcm_s16be_planar_encoder", "pcm_s16le_decoder", "pcm_s16le_encoder", "pcm_s16le_planar_decoder", "pcm_s16le_planar_encoder", "pcm_s24be_decoder", "pcm_s24be_encoder", "pcm_s24daud_decoder", "pcm_s24daud_encoder", "pcm_s24le_decoder", "pcm_s24le_encoder", "pcm_s24le_planar_decoder", "pcm_s24le_planar_encoder", "pcm_s32be_decoder", "pcm_s32be_encoder", "pcm_s32le_decoder", "pcm_s32le_encoder", "pcm_s32le_planar_decoder", "pcm_s32le_planar_encoder", "pcm_s64be_decoder", "pcm_s64be_encoder", "pcm_s64le_decoder", "pcm_s64le_encoder", "pcm_s8_decoder", "pcm_s8_encoder", "pcm_s8_planar_decoder", "pcm_s8_planar_encoder", "pcm_sga_decoder", "pcm_u16be_decoder", "pcm_u16be_encoder", "pcm_u16le_decoder", "pcm_u16le_encoder", "pcm_u24be_decoder", "pcm_u24be_encoder", "pcm_u24le_decoder", "pcm_u24le_encoder", "pcm_u32be_decoder", "pcm_u32be_encoder", "pcm_u32le_decoder", "pcm_u32le_encoder", "pcm_u8_decoder", "pcm_u8_encoder", "pcm_vidc_decoder", "pcm_vidc_encoder"]),
    ("shared_group_194", ["pjs_decoder", "stl_decoder", "subviewer1_decoder", "text_decoder", "vplayer_decoder"]),
    ("shared_group_195", ["prores_aw_encoder", "prores_decoder", "prores_encoder", "prores_ks_encoder", "prores_ks_vulkan_encoder", "prores_raw_decoder"]),
    ("shared_group_196", ["prores_aw_encoder", "prores_encoder"]),
    ("shared_group_197", ["prores_decoder", "prores_raw_decoder"]),
    ("shared_group_198", ["prores_ks_encoder", "prores_ks_vulkan_encoder"]),
    ("shared_group_199", ["ra_144_decoder", "ra_144_encoder"]),
    ("shared_group_2", ["ac3_decoder", "ac3_encoder", "ac3_fixed_decoder", "ac3_fixed_encoder", "ac3_parser", "ac3dsp"]),
    ("shared_group_20", ["intrax8", "msmpeg4dec", "msmpeg4enc", "vc1_decoder"]),
    ("shared_group_200", ["roq_decoder", "roq_encoder"]),
    ("shared_group_201", ["rv10_decoder", "rv20_decoder"]),
    ("shared_group_202", ["rv30_decoder", "rv40_decoder"]),
    ("shared_group_203", ["sami_decoder", "srt_decoder", "subrip_decoder"]),
    ("shared_group_204", ["sbc_decoder", "sbc_encoder"]),
    ("shared_group_205", ["sgi_encoder", "targa_encoder", "tiff_encoder"]),
    ("shared_group_206", ["smackaud_decoder", "smacker_decoder"]),
    ("shared_group_207", ["snow_decoder", "snow_encoder"]),
    ("shared_group_208", ["speedhq_decoder", "speedhq_encoder"]),
    ("shared_group_209", ["srt_decoder", "subrip_decoder"]),
    ("shared_group_21", ["iso_media", "mp2_encoder", "mp2fixed_encoder", "mp3_muxer", "mpegaudioheader", "nut_muxer"]),
    ("shared_group_210", ["srt_encoder", "subrip_encoder", "text_encoder"]),
    ("shared_group_211", ["svq1_decoder", "svq1_encoder"]),
    ("shared_group_212", ["tak_decoder", "tak_demuxer", "tak_parser"]),
    ("shared_group_213", ["tta_decoder", "tta_encoder"]),
    ("shared_group_214", ["vc1_d3d11va_hwaccel", "vc1_d3d12va_hwaccel", "vc1_dxva2_hwaccel"]),
    ("shared_group_215", ["vc1_decoder", "vc1_parser"]),
    ("shared_group_216", ["vorbis_decoder", "vorbis_encoder"]),
    ("shared_group_217", ["vp5_decoder", "vp6_decoder"]),
    ("shared_group_218", ["vp5_decoder", "vp6_decoder", "vp7_decoder", "vp8_decoder", "vp9_decoder"]),
    ("shared_group_219", ["vp7_decoder", "vp8_decoder"]),
    ("shared_group_22", ["jpegtables", "rtp_muxer", "rtpdec"]),
    ("shared_group_220", ["vp9_d3d11va_hwaccel", "vp9_d3d12va_hwaccel", "vp9_dxva2_hwaccel"]),
    ("shared_group_221", ["wavpack_decoder", "wavpack_encoder"]),
    ("shared_group_222", ["webp_anim_decoder", "webp_decoder"]),
    ("shared_group_223", ["wmalossless_decoder", "wmapro_decoder", "wmav1_decoder", "wmav1_encoder", "wmav2_decoder", "wmav2_encoder", "xma1_decoder", "xma2_decoder"]),
    ("shared_group_224", ["wmapro_decoder", "wmav1_decoder", "wmav1_encoder", "wmav2_decoder", "wmav2_encoder", "xma1_decoder", "xma2_decoder"]),
    ("shared_group_225", ["wmapro_decoder", "xma1_decoder", "xma2_decoder"]),
    ("shared_group_226", ["wmav1_decoder", "wmav2_decoder"]),
    ("shared_group_227", ["wmav1_encoder", "wmav2_encoder"]),
    ("shared_group_228", ["wrapped_avframe_decoder", "wrapped_avframe_encoder"]),
    ("shared_group_229", ["xface_decoder", "xface_encoder"]),
    ("shared_group_23", ["mp2_encoder", "mp2fixed_encoder", "mpegaudio"]),
    ("shared_group_230", ["h264qpel", "hpeldsp"]),
    ("shared_group_231", ["hevc_decoder", "vvc_decoder"]),
    ("shared_group_232", ["h264qpel", "hpeldsp", "qpeldsp", "vc1dsp"]),
    ("shared_group_233", ["h264qpel", "qpeldsp"]),
    ("shared_group_234", ["cbs_apv_lavf", "cbs_av1_lavf"]),
    ("shared_group_235", ["iamfdec", "iamfenc"]),
    ("shared_group_236", ["iso_writer", "whip_muxer"]),
    ("shared_group_237", ["mlv_demuxer", "riffdec"]),
    ("shared_group_238", ["mov_muxer", "rtp_muxer", "rtpdec", "rtpenc_chain"]),
    ("shared_group_239", ["srtp", "srtp_protocol", "whip_muxer"]),
    ("shared_group_24", ["mp2_encoder", "mp2fixed_encoder", "mpegaudiodsp"]),
    ("shared_group_240", ["a64_muxer", "ac3_muxer", "adx_muxer", "aea_muxer", "alp_muxer", "amr_muxer", "apm_muxer", "aptx_hd_muxer", "aptx_muxer", "au_muxer", "avs2_muxer", "avs3_muxer", "cavsvideo_muxer", "codec2_muxer", "codec2raw_muxer", "data_muxer", "dfpwm_muxer", "dirac_muxer", "dnxhd_muxer", "dts_muxer", "eac3_muxer", "evc_muxer", "filmstrip_muxer", "g722_muxer", "g723_1_muxer", "g726_muxer", "g726le_muxer", "gsm_muxer", "h261_muxer", "h263_muxer", "h264_muxer", "hevc_muxer", "ilbc_muxer", "ircam_muxer", "jacosub_muxer", "kvag_muxer", "latm_muxer", "m4v_muxer", "mjpeg_muxer", "mlp_muxer", "mmf_muxer", "mp2_muxer", "mp3_muxer", "mpeg1video_muxer", "mpeg2video_muxer", "obu_muxer", "oma_muxer", "pcm_alaw_muxer", "pcm_f32be_muxer", "pcm_f32le_muxer", "pcm_f64be_muxer", "pcm_f64le_muxer", "pcm_mulaw_muxer", "pcm_s16be_muxer", "pcm_s16le_muxer", "pcm_s24be_muxer", "pcm_s24le_muxer", "pcm_s32be_muxer", "pcm_s32le_muxer", "pcm_s8_muxer", "pcm_u16be_muxer", "pcm_u16le_muxer", "pcm_u24be_muxer", "pcm_u24le_muxer", "pcm_u32be_muxer", "pcm_u32le_muxer", "pcm_u8_muxer", "pcm_vidc_muxer", "rawvideo_muxer", "roq_muxer", "rso_muxer", "sbc_muxer", "sox_muxer", "truehd_muxer", "vc1_muxer", "vvc_muxer"]),
    ("shared_group_241", ["aac_demuxer", "ac3_demuxer", "acm_demuxer", "adx_demuxer", "amr_demuxer", "amrnb_demuxer", "amrwb_demuxer", "apac_demuxer", "avs2_demuxer", "avs3_demuxer", "bonk_demuxer", "cavsvideo_demuxer", "data_demuxer", "dirac_demuxer", "dnxhd_demuxer", "dts_demuxer", "dvbsub_demuxer", "dvbtxt_demuxer", "eac3_demuxer", "evc_demuxer", "flac_demuxer", "g722_demuxer", "h261_demuxer", "h263_demuxer", "h264_demuxer", "hevc_demuxer", "ingenient_demuxer", "ipu_demuxer", "loas_demuxer", "m4v_demuxer", "mjpeg_2000_demuxer", "mjpeg_demuxer", "mlp_demuxer", "mpegvideo_demuxer", "osq_demuxer", "sbc_demuxer", "shorten_demuxer", "tak_demuxer", "truehd_demuxer", "vc1_demuxer", "vvc_demuxer", "wsd_demuxer"]),
    ("shared_group_242", ["aac_demuxer", "adts_muxer", "ape_demuxer", "image2_demuxer", "image2_muxer", "image2pipe_demuxer", "image2pipe_muxer", "image_bmp_pipe_demuxer", "image_cri_pipe_demuxer", "image_dds_pipe_demuxer", "image_dpx_pipe_demuxer", "image_exr_pipe_demuxer", "image_gem_pipe_demuxer", "image_gif_pipe_demuxer", "image_hdr_pipe_demuxer", "image_j2k_pipe_demuxer", "image_jpeg_pipe_demuxer", "image_jpegls_pipe_demuxer", "image_jpegxl_pipe_demuxer", "image_jpegxs_pipe_demuxer", "image_pam_pipe_demuxer", "image_pbm_pipe_demuxer", "image_pcx_pipe_demuxer", "image_pfm_pipe_demuxer", "image_pgm_pipe_demuxer", "image_pgmyuv_pipe_demuxer", "image_pgx_pipe_demuxer", "image_phm_pipe_demuxer", "image_photocd_pipe_demuxer", "image_pictor_pipe_demuxer", "image_png_pipe_demuxer", "image_ppm_pipe_demuxer", "image_psd_pipe_demuxer", "image_qdraw_pipe_demuxer", "image_qoi_pipe_demuxer", "image_sgi_pipe_demuxer", "image_sunrast_pipe_demuxer", "image_svg_pipe_demuxer", "image_tiff_pipe_demuxer", "image_vbn_pipe_demuxer", "image_webp_pipe_demuxer", "image_xbm_pipe_demuxer", "image_xpm_pipe_demuxer", "image_xwd_pipe_demuxer", "mpc8_demuxer", "mpc_demuxer", "rka_demuxer", "tak_demuxer", "tta_demuxer", "tta_muxer", "wv_demuxer", "wv_muxer"]),
    ("shared_group_243", ["aac_demuxer", "adts_muxer", "ape_demuxer", "mpc8_demuxer", "mpc_demuxer", "rka_demuxer", "tak_demuxer", "tta_demuxer", "tta_muxer", "wv_demuxer", "wv_muxer"]),
    ("shared_group_244", ["ac3_demuxer", "eac3_demuxer"]),
    ("shared_group_245", ["adf_demuxer", "bintext_demuxer", "idf_demuxer", "tty_demuxer", "xbin_demuxer"]),
    ("shared_group_246", ["adf_demuxer", "bintext_demuxer", "idf_demuxer", "xbin_demuxer"]),
    ("shared_group_247", ["adts_muxer", "aiff_muxer", "mp3_muxer", "oma_muxer"]),
    ("shared_group_248", ["aea_demuxer", "aiff_demuxer", "au_demuxer", "avr_demuxer", "codec2_demuxer", "codec2raw_demuxer", "derf_demuxer", "dfpwm_demuxer", "epaf_demuxer", "fwse_demuxer", "hcom_demuxer", "ircam_demuxer", "nistsphere_demuxer", "nsp_demuxer", "oma_demuxer", "pcm_alaw_demuxer", "pcm_f32be_demuxer", "pcm_f32le_demuxer", "pcm_f64be_demuxer", "pcm_f64le_demuxer", "pcm_mulaw_demuxer", "pcm_s16be_demuxer", "pcm_s16le_demuxer", "pcm_s24be_demuxer", "pcm_s24le_demuxer", "pcm_s32be_demuxer", "pcm_s32le_demuxer", "pcm_s8_demuxer", "pcm_u16be_demuxer", "pcm_u16le_demuxer", "pcm_u24be_demuxer", "pcm_u24le_demuxer", "pcm_u32be_demuxer", "pcm_u32le_demuxer", "pcm_u8_demuxer", "pcm_vidc_demuxer", "pvf_demuxer", "rso_demuxer", "sdx_demuxer", "sln_demuxer", "sol_demuxer", "sox_demuxer", "w64_demuxer", "wady_demuxer", "wav_demuxer", "wve_demuxer", "xmd_demuxer"]),
    ("shared_group_249", ["aiff_demuxer", "aiff_muxer"]),
    ("shared_group_25", ["mpegvideodec", "svq3_decoder"]),
    ("shared_group_250", ["aiff_demuxer", "caf_demuxer", "mov_demuxer", "mov_muxer"]),
    ("shared_group_251", ["aiff_demuxer", "flac_demuxer", "matroska_demuxer", "mov_demuxer", "mp3_demuxer", "ogg_demuxer"]),
    ("shared_group_252", ["alp_demuxer", "alp_muxer"]),
    ("shared_group_253", ["amr_demuxer", "amr_muxer", "amrnb_demuxer", "amrwb_demuxer"]),
    ("shared_group_254", ["android_content_protocol", "fd_protocol", "file_protocol", "pipe_protocol"]),
    ("shared_group_255", ["apm_demuxer", "apm_muxer"]),
    ("shared_group_256", ["aptx_demuxer", "aptx_hd_demuxer"]),
    ("shared_group_257", ["aqtitle_demuxer", "ass_demuxer", "jacosub_demuxer", "lrc_demuxer", "mcc_demuxer", "microdvd_demuxer", "mpl2_demuxer", "mpsub_demuxer", "pjs_demuxer", "rcwt_demuxer", "rcwt_muxer", "realtext_demuxer", "sami_demuxer", "scc_demuxer", "srt_demuxer", "stl_demuxer", "subviewer1_demuxer", "subviewer_demuxer", "tedcaptions_demuxer", "vobsub_demuxer", "vplayer_demuxer", "webvtt_demuxer"]),
    ("shared_group_258", ["argo_asf_demuxer", "argo_asf_muxer", "argo_brp_demuxer"]),
    ("shared_group_259", ["argo_cvg_demuxer", "argo_cvg_muxer"]),
    ("shared_group_26", ["mpegvideoenc", "snow_encoder"]),
    ("shared_group_260", ["asf_demuxer", "asf_muxer", "asf_o_demuxer", "avi_muxer", "matroska_muxer", "mxf_demuxer", "webm_muxer"]),
    ("shared_group_261", ["asf_demuxer", "asf_muxer", "asf_o_demuxer", "mmsh_protocol", "mmst_protocol"]),
    ("shared_group_262", ["asf_demuxer", "asf_muxer", "asf_o_demuxer", "wtv_demuxer", "wtv_muxer"]),
    ("shared_group_263", ["asf_demuxer", "asf_o_demuxer"]),
    ("shared_group_264", ["ast_demuxer", "ast_muxer"]),
    ("shared_group_265", ["au_demuxer", "au_muxer"]),
    ("shared_group_266", ["av1_demuxer", "obu_demuxer"]),
    ("shared_group_267", ["avi_muxer", "mov_muxer"]),
    ("shared_group_268", ["avi_muxer", "mpegts_muxer"]),
    ("shared_group_269", ["avm2_muxer", "swf_demuxer", "swf_muxer"]),
    ("shared_group_27", ["mpegvideoenc", "snow_encoder", "svq1_encoder"]),
    ("shared_group_270", ["avm2_muxer", "swf_muxer"]),
    ("shared_group_271", ["avs_demuxer", "c93_demuxer", "voc_demuxer"]),
    ("shared_group_272", ["avs_demuxer", "c93_demuxer", "voc_demuxer", "voc_muxer"]),
    ("shared_group_273", ["bfstm_demuxer", "brstm_demuxer"]),
    ("shared_group_274", ["bit_demuxer", "bit_muxer"]),
    ("shared_group_275", ["bitpacked_demuxer", "rawvideo_demuxer", "v210_demuxer", "v210x_demuxer"]),
    ("shared_group_276", ["caf_demuxer", "caf_muxer"]),
    ("shared_group_277", ["caf_demuxer", "mov_demuxer"]),
    ("shared_group_278", ["codec2_demuxer", "codec2_muxer", "codec2raw_demuxer"]),
    ("shared_group_279", ["concat_protocol", "concatf_protocol"]),
    ("shared_group_28", ["msmpeg4dec", "msmpeg4enc"]),
    ("shared_group_280", ["dash_demuxer", "dash_muxer"]),
    ("shared_group_281", ["dash_muxer", "hls_muxer"]),
    ("shared_group_282", ["dtls_protocol", "tls_protocol"]),
    ("shared_group_283", ["dvdvideo_demuxer", "mov_demuxer"]),
    ("shared_group_284", ["ffrtmpcrypt_protocol", "rtmp_protocol", "rtmpe_protocol", "rtmps_protocol", "rtmpt_protocol", "rtmpte_protocol", "rtmpts_protocol"]),
    ("shared_group_285", ["flac_demuxer", "flac_muxer", "matroska_demuxer", "matroska_muxer", "oga_muxer", "ogg_demuxer", "ogg_muxer", "ogv_muxer", "opus_muxer"]),
    ("shared_group_286", ["flac_demuxer", "matroska_demuxer", "ogg_demuxer"]),
    ("shared_group_287", ["flac_muxer", "matroska_muxer"]),
    ("shared_group_288", ["flv_demuxer", "kux_demuxer", "live_flv_demuxer"]),
    ("shared_group_289", ["framecrc_muxer", "framehash_muxer", "framemd5_muxer", "uncodedframecrc_muxer"]),
    ("shared_group_29", ["a64multi5_encoder", "a64multi_encoder"]),
    ("shared_group_290", ["framehash_muxer", "framemd5_muxer", "hash_muxer", "md5_muxer", "streamhash_muxer"]),
    ("shared_group_291", ["g726_demuxer", "g726le_demuxer"]),
    ("shared_group_292", ["gopher_protocol", "gophers_protocol"]),
    ("shared_group_293", ["http_protocol", "httpproxy_protocol", "https_protocol", "rtsp_demuxer", "rtsp_muxer"]),
    ("shared_group_294", ["http_protocol", "httpproxy_protocol", "https_protocol", "whip_muxer"]),
    ("shared_group_295", ["ilbc_demuxer", "ilbc_muxer"]),
    ("shared_group_296", ["image2_demuxer", "image2pipe_demuxer", "image_bmp_pipe_demuxer", "image_cri_pipe_demuxer", "image_dds_pipe_demuxer", "image_dpx_pipe_demuxer", "image_exr_pipe_demuxer", "image_gem_pipe_demuxer", "image_gif_pipe_demuxer", "image_hdr_pipe_demuxer", "image_j2k_pipe_demuxer", "image_jpeg_pipe_demuxer", "image_jpegls_pipe_demuxer", "image_jpegxl_pipe_demuxer", "image_jpegxs_pipe_demuxer", "image_pam_pipe_demuxer", "image_pbm_pipe_demuxer", "image_pcx_pipe_demuxer", "image_pfm_pipe_demuxer", "image_pgm_pipe_demuxer", "image_pgmyuv_pipe_demuxer", "image_pgx_pipe_demuxer", "image_phm_pipe_demuxer", "image_photocd_pipe_demuxer", "image_pictor_pipe_demuxer", "image_png_pipe_demuxer", "image_ppm_pipe_demuxer", "image_psd_pipe_demuxer", "image_qdraw_pipe_demuxer", "image_qoi_pipe_demuxer", "image_sgi_pipe_demuxer", "image_sunrast_pipe_demuxer", "image_svg_pipe_demuxer", "image_tiff_pipe_demuxer", "image_vbn_pipe_demuxer", "image_webp_pipe_demuxer", "image_xbm_pipe_demuxer", "image_xpm_pipe_demuxer", "image_xwd_pipe_demuxer"]),
    ("shared_group_297", ["image2_muxer", "image2pipe_muxer"]),
    ("shared_group_298", ["ipfs_gateway_protocol", "ipns_gateway_protocol"]),
    ("shared_group_299", ["ircam_demuxer", "ircam_muxer"]),
    ("shared_group_3", ["ac3_decoder", "ac3_encoder", "ac3_fixed_decoder", "ac3_fixed_encoder", "ac3dsp"]),
    ("shared_group_30", ["a64multi5_encoder", "a64multi_encoder", "cinepak_encoder", "elbg_filter", "msvideo1_encoder", "roq_encoder"]),
    ("shared_group_300", ["ivr_demuxer", "matroska_demuxer", "rm_demuxer"]),
    ("shared_group_301", ["ivr_demuxer", "rm_demuxer"]),
    ("shared_group_302", ["ivr_demuxer", "rm_demuxer", "rm_muxer"]),
    ("shared_group_303", ["kvag_demuxer", "kvag_muxer"]),
    ("shared_group_304", ["lc3_demuxer", "lc3_muxer"]),
    ("shared_group_305", ["librtmp_protocol", "librtmpe_protocol", "librtmps_protocol", "librtmpt_protocol", "librtmpte_protocol"]),
    ("shared_group_306", ["lrc_demuxer", "lrc_muxer"]),
    ("shared_group_307", ["matroska_demuxer", "matroska_muxer", "mov_demuxer", "mov_muxer"]),
    ("shared_group_308", ["matroska_demuxer", "matroska_muxer", "webm_muxer"]),
    ("shared_group_309", ["matroska_demuxer", "mov_demuxer"]),
    ("shared_group_31", ["aac_at_decoder", "ac3_at_decoder", "adpcm_ima_qt_at_decoder", "alac_at_decoder", "amr_nb_at_decoder", "eac3_at_decoder", "gsm_ms_at_decoder", "ilbc_at_decoder", "mp1_at_decoder", "mp2_at_decoder", "mp3_at_decoder", "pcm_alaw_at_decoder", "pcm_mulaw_at_decoder", "qdm2_at_decoder", "qdmc_at_decoder"]),
    ("shared_group_310", ["matroska_muxer", "webm_muxer"]),
    ("shared_group_311", ["matroska_muxer", "wv_demuxer", "wv_muxer"]),
    ("shared_group_312", ["mlp_demuxer", "truehd_demuxer"]),
    ("shared_group_313", ["mmf_demuxer", "mmf_muxer"]),
    ("shared_group_314", ["mmsh_protocol", "mmst_protocol"]),
    ("shared_group_315", ["mpeg1system_muxer", "mpeg1vcd_muxer", "mpeg2dvd_muxer", "mpeg2svcd_muxer", "mpeg2vob_muxer"]),
    ("shared_group_316", ["mxf_demuxer", "mxf_muxer"]),
    ("shared_group_317", ["nut_demuxer", "nut_muxer"]),
    ("shared_group_318", ["oga_muxer", "ogg_muxer", "ogv_muxer", "opus_muxer"]),
    ("shared_group_319", ["oma_demuxer", "oma_muxer"]),
    ("shared_group_32", ["aac_at_encoder", "alac_at_encoder", "ilbc_at_encoder", "pcm_alaw_at_encoder", "pcm_mulaw_at_encoder"]),
    ("shared_group_320", ["pcm_alaw_demuxer", "pcm_f32be_demuxer", "pcm_f32le_demuxer", "pcm_f64be_demuxer", "pcm_f64le_demuxer", "pcm_mulaw_demuxer", "pcm_s16be_demuxer", "pcm_s16le_demuxer", "pcm_s24be_demuxer", "pcm_s24le_demuxer", "pcm_s32be_demuxer", "pcm_s32le_demuxer", "pcm_s8_demuxer", "pcm_u16be_demuxer", "pcm_u16le_demuxer", "pcm_u24be_demuxer", "pcm_u24le_demuxer", "pcm_u32be_demuxer", "pcm_u32le_demuxer", "pcm_u8_demuxer", "pcm_vidc_demuxer", "sln_demuxer"]),
    ("shared_group_321", ["pcm_alaw_muxer", "pcm_f32be_muxer", "pcm_f32le_muxer", "pcm_f64be_muxer", "pcm_f64le_muxer", "pcm_mulaw_muxer", "pcm_s16be_muxer", "pcm_s16le_muxer", "pcm_s24be_muxer", "pcm_s24le_muxer", "pcm_s32be_muxer", "pcm_s32le_muxer", "pcm_s8_muxer", "pcm_u16be_muxer", "pcm_u16le_muxer", "pcm_u24be_muxer", "pcm_u24le_muxer", "pcm_u32be_muxer", "pcm_u32le_muxer", "pcm_u8_muxer", "pcm_vidc_muxer"]),
    ("shared_group_322", ["rso_demuxer", "rso_muxer"]),
    ("shared_group_323", ["rtmp_protocol", "rtmpe_protocol", "rtmps_protocol", "rtmpt_protocol", "rtmpte_protocol", "rtmpts_protocol"]),
    ("shared_group_324", ["rtp_protocol", "udp_protocol", "udplite_protocol"]),
    ("shared_group_325", ["rtsp_demuxer", "rtsp_muxer", "sdp_demuxer"]),
    ("shared_group_326", ["s337m_demuxer", "spdif_demuxer", "spdif_muxer"]),
    ("shared_group_327", ["segment_muxer", "stream_segment_muxer"]),
    ("shared_group_328", ["smjpeg_demuxer", "smjpeg_muxer"]),
    ("shared_group_329", ["tee_muxer", "tee_protocol"]),
    ("shared_group_33", ["aac_decoder", "aac_encoder", "aac_fixed_decoder", "ac3_decoder", "ac3_encoder", "ac3_fixed_decoder", "ac3_fixed_encoder", "dolby_e_decoder"]),
    ("shared_group_330", ["udp_protocol", "udplite_protocol"]),
    ("shared_group_331", ["w64_demuxer", "w64_muxer"]),
    ("shared_group_332", ["w64_demuxer", "wav_demuxer"]),
    ("shared_group_333", ["w64_muxer", "wav_muxer"]),
    ("shared_group_334", ["wtv_demuxer", "wtv_muxer"]),
    ("shared_group_335", ["abench_filter", "bench_filter"]),
    ("shared_group_336", ["acompressor_filter", "sidechaincompress_filter"]),
    ("shared_group_337", ["acrossfade_filter", "afade_filter"]),
    ("shared_group_338", ["acue_filter", "cue_filter"]),
    ("shared_group_339", ["adeclick_filter", "adeclip_filter"]),
    ("shared_group_34", ["aac_decoder", "aac_encoder", "aac_fixed_decoder", "wmav1_decoder", "wmav1_encoder", "wmav2_decoder", "wmav2_encoder"]),
    ("shared_group_340", ["aderivative_filter", "aintegral_filter"]),
    ("shared_group_341", ["adrawgraph_filter", "drawgraph_filter"]),
    ("shared_group_342", ["aeval_filter", "aevalsrc_filter"]),
    ("shared_group_343", ["afireqsrc_filter", "afirsrc_filter"]),
    ("shared_group_344", ["afreqshift_filter", "aphaseshift_filter"]),
    ("shared_group_345", ["agate_filter", "sidechaingate_filter"]),
    ("shared_group_346", ["agraphmonitor_filter", "graphmonitor_filter"]),
    ("shared_group_347", ["ainterleave_filter", "interleave_filter"]),
    ("shared_group_348", ["alatency_filter", "latency_filter"]),
    ("shared_group_349", ["allpass_filter", "bandpass_filter", "bandreject_filter", "bass_filter", "biquad_filter", "equalizer_filter", "highpass_filter", "highshelf_filter", "lowpass_filter", "lowshelf_filter", "tiltshelf_filter", "treble_filter"]),
    ("shared_group_35", ["aac_decoder", "aac_fixed_decoder"]),
    ("shared_group_350", ["allrgb_filter", "allyuv_filter", "color_filter", "colorchart_filter", "colorspectrum_filter", "haldclutsrc_filter", "nullsrc_filter", "pal100bars_filter", "pal75bars_filter", "rgbtestsrc_filter", "smptebars_filter", "smptehdbars_filter", "testsrc2_filter", "testsrc_filter", "yuvtestsrc_filter", "zoneplate_filter"]),
    ("shared_group_351", ["aloop_filter", "loop_filter"]),
    ("shared_group_352", ["alphaextract_filter", "extractplanes_filter"]),
    ("shared_group_353", ["alphamerge_filter", "astreamselect_filter", "blend_filter", "blend_vulkan_filter", "bm3d_filter", "colormap_filter", "convolve_filter", "corr_filter", "deconvolve_filter", "displace_filter", "guided_filter", "haldclut_filter", "hstack_filter", "hstack_qsv_filter", "hstack_vaapi_filter", "hysteresis_filter", "identity_filter", "libvmaf_cuda_filter", "libvmaf_filter", "limitdiff_filter", "lut2_filter", "lut3d_filter", "maskedclamp_filter", "maskedmax_filter", "maskedmerge_filter", "maskedmin_filter", "maskedthreshold_filter", "mergeplanes_filter", "midequalizer_filter", "mix_filter", "morpho_filter", "msad_filter", "multiply_filter", "overlay_cuda_filter", "overlay_filter", "overlay_opencl_filter", "overlay_qsv_filter", "overlay_vaapi_filter", "paletteuse_filter", "premultiply_dynamic_filter", "premultiply_filter", "program_opencl_filter", "psnr_filter", "remap_filter", "remap_opencl_filter", "scale2ref_filter", "scale_filter", "ssim360_filter", "ssim_filter", "streamselect_filter", "tblend_filter", "threshold_filter", "tlut2_filter", "tmedian_filter", "tmix_filter", "unpremultiply_filter", "varblur_filter", "vif_filter", "vmafmotion_filter", "vstack_filter", "vstack_qsv_filter", "vstack_vaapi_filter", "xcorrelate_filter", "xmedian_filter", "xpsnr_filter", "xstack_filter", "xstack_qsv_filter", "xstack_vaapi_filter"]),
    ("shared_group_354", ["ametadata_filter", "metadata_filter"]),
    ("shared_group_355", ["amovie_filter", "movie_filter"]),
    ("shared_group_356", ["anlmf_filter", "anlms_filter"]),
    ("shared_group_357", ["aperms_filter", "perms_filter"]),
    ("shared_group_358", ["aphaser_filter", "chorus_filter", "flanger_filter", "vibrato_filter"]),
    ("shared_group_359", ["apsnr_filter", "asdr_filter", "asisdr_filter"]),
    ("shared_group_36", ["aac_mediacodec_decoder", "amrnb_mediacodec_decoder", "amrwb_mediacodec_decoder", "av1_mediacodec_decoder", "h264_mediacodec_decoder", "hevc_mediacodec_decoder", "mp3_mediacodec_decoder", "mpeg2_mediacodec_decoder", "mpeg4_mediacodec_decoder", "vp8_mediacodec_decoder", "vp9_mediacodec_decoder"]),
    ("shared_group_360", ["arealtime_filter", "realtime_filter"]),
    ("shared_group_361", ["areverse_filter", "reverse_filter"]),
    ("shared_group_362", ["asegment_filter", "segment_filter"]),
    ("shared_group_363", ["aselect_filter", "select_filter"]),
    ("shared_group_364", ["asendcmd_filter", "sendcmd_filter"]),
    ("shared_group_365", ["asetpts_filter", "setpts_filter"]),
    ("shared_group_366", ["asettb_filter", "settb_filter"]),
    ("shared_group_367", ["asidedata_filter", "sidedata_filter"]),
    ("shared_group_368", ["asplit_filter", "split_filter"]),
    ("shared_group_369", ["ass_filter", "subtitles_filter"]),
    ("shared_group_37", ["aac_mf_encoder", "ac3_mf_encoder", "h264_mf_encoder", "hevc_mf_encoder", "mp3_mf_encoder"]),
    ("shared_group_370", ["astreamselect_filter", "streamselect_filter"]),
    ("shared_group_371", ["asubcut_filter", "asupercut_filter", "asuperpass_filter", "asuperstop_filter"]),
    ("shared_group_372", ["atrim_filter", "trim_filter"]),
    ("shared_group_373", ["avgblur_opencl_filter", "boxblur_filter", "boxblur_opencl_filter"]),
    ("shared_group_374", ["avgblur_opencl_filter", "boxblur_opencl_filter"]),
    ...
    ("shared_group_376", ["avgblur_vulkan_filter", "blend_vulkan_filter", "bwdif_vulkan_filter", "chromaber_vulkan_filter", "color_vulkan_filter", "gblur_vulkan_filter", "hflip_vulkan_filter", "interlace_vulkan_filter", "libplacebo_filter", "nlmeans_vulkan_filter", "overlay_vulkan_filter", "scale_vulkan_filter", "transpose_vulkan_filter", "vflip_vulkan_filter", "xfade_vulkan_filter"]),
    ("shared_group_377", ["avgblur_vulkan_filter", "blend_vulkan_filter", "bwdif_vulkan_filter", "chromaber_vulkan_filter", "color_vulkan_filter", "gblur_vulkan_filter", "interlace_vulkan_filter", "libplacebo_filter", "nlmeans_vulkan_filter", "overlay_vulkan_filter", "scale_vulkan_filter", "transpose_vulkan_filter", "xfade_vulkan_filter"]),
    ("shared_group_378", ["azmq_filter", "zmq_filter"]),
    ("shared_group_379", ["bbox_filter", "removelogo_filter"]),
    ("shared_group_38", ["aac_parser", "ac3_parser"]),
    ("shared_group_380", ["blend_filter", "tblend_filter"]),
    ("shared_group_381", ["blurdetect_filter", "cropdetect_filter", "edgedetect_filter"]),
    ("shared_group_382", ["bwdif_cuda_filter", "bwdif_filter", "bwdif_vulkan_filter", "yadif_cuda_filter", "yadif_filter", "yadif_videotoolbox_filter"]),
    ("shared_group_383", ["chromahold_filter", "chromakey_filter"]),
    ("shared_group_384", ["chromashift_filter", "rgbashift_filter"]),
    ("shared_group_385", ["codecview_filter", "fspp_filter", "pp7_filter", "spp_filter", "uspp_filter"]),
    ("shared_group_386", ["colorhold_filter", "colorkey_filter"]),
    ("shared_group_387", ["colorspace_cuda_filter", "overlay_cuda_filter", "pad_cuda_filter", "scale_cuda_filter", "thumbnail_cuda_filter", "transpose_cuda_filter", "yadif_cuda_filter"]),
    ("shared_group_388", ["convolution_filter", "kirsch_filter", "prewitt_filter", "roberts_filter", "scharr_filter", "sobel_filter"]),
    ("shared_group_389", ["convolution_opencl_filter", "prewitt_opencl_filter", "roberts_opencl_filter", "sobel_opencl_filter"]),
    ("shared_group_39", ["aasc_decoder", "bmp_decoder", "msrle_decoder", "tscc_decoder"]),
    ("shared_group_390", ["convolve_filter", "deconvolve_filter", "xcorrelate_filter"]),
    ("shared_group_391", ["cover_rect_filter", "find_rect_filter", "removelogo_filter", "showcqt_filter"]),
    ("shared_group_392", ["datascope_filter", "oscilloscope_filter", "pixscope_filter"]),
    ("shared_group_393", ["deflate_filter", "dilation_filter", "erosion_filter", "inflate_filter"]),
    ("shared_group_394", ["deinterlace_qsv_filter", "scale_qsv_filter", "vpp_qsv_filter"]),
    ("shared_group_395", ["deinterlace_vaapi_filter", "denoise_vaapi_filter", "drawbox_vaapi_filter", "hstack_vaapi_filter", "overlay_vaapi_filter", "pad_vaapi_filter", "procamp_vaapi_filter", "scale_vaapi_filter", "sharpness_vaapi_filter", "tonemap_vaapi_filter", "transpose_vaapi_filter", "vstack_vaapi_filter", "xstack_vaapi_filter"]),
    ("shared_group_396", ["denoise_vaapi_filter", "sharpness_vaapi_filter"]),
    ("shared_group_397", ["deshake_filter", "deshake_opencl_filter"]),
    ("shared_group_398", ["dilation_opencl_filter", "erosion_opencl_filter"]),
    ("shared_group_399", ["doubleweave_filter", "weave_filter"]),
    ("shared_group_4", ["acelp_kelvin_decoder", "evrc_decoder", "g729_decoder", "lsp"]),
    ("shared_group_40", ["ac3_decoder", "ac3_fixed_decoder"]),
    ("shared_group_400", ["drawbox_filter", "drawgrid_filter"]),
    ("shared_group_401", ["drawtext_filter", "drawvg_filter", "qrencode_filter", "qrencodesrc_filter"]),
    ("shared_group_402", ["format_filter", "noformat_filter"]),
    ("shared_group_403", ["frc_amf_filter", "sr_amf_filter", "vpp_amf_filter"]),
    ("shared_group_404", ["frei0r_filter", "frei0r_src_filter"]),
    ("shared_group_405", ["haldclut_filter", "lut1d_filter", "lut3d_filter"]),
    ("shared_group_406", ["hflip_vulkan_filter", "vflip_vulkan_filter"]),
    ("shared_group_407", ["histogram_filter", "thistogram_filter"]),
    ("shared_group_408", ["hstack_filter", "vstack_filter", "xstack_filter"]),
    ("shared_group_409", ["hstack_qsv_filter", "vstack_qsv_filter", "xstack_qsv_filter"]),
    ("shared_group_41", ["ac3_decoder", "ac3_fixed_decoder", "ac3_parser", "hls_demuxer", "mov_demuxer"]),
    ("shared_group_410", ["hstack_vaapi_filter", "vstack_vaapi_filter", "xstack_vaapi_filter"]),
    ("shared_group_411", ["hsvhold_filter", "hsvkey_filter"]),
    ("shared_group_412", ["iccdetect_filter", "iccgen_filter"]),
    ("shared_group_413", ["identity_filter", "msad_filter"]),
    ("shared_group_414", ["interlace_filter", "tinterlace_filter"]),
    ("shared_group_415", ["libvmaf_cuda_filter", "libvmaf_filter"]),
    ("shared_group_416", ["lut2_filter", "tlut2_filter"]),
    ("shared_group_417", ["lut_filter", "lutrgb_filter", "lutyuv_filter"]),
    ("shared_group_418", ["maskedmax_filter", "maskedmin_filter"]),
    ("shared_group_419", ["mestimate_filter", "minterpolate_filter"]),
    ("shared_group_42", ["ac3_encoder", "ac3_fixed_encoder"]),
    ("shared_group_420", ["mix_filter", "tmix_filter"]),
    ("shared_group_421", ["openclsrc_filter", "program_opencl_filter"]),
    ("shared_group_422", ["palettegen_filter", "paletteuse_filter"]),
    ("shared_group_423", ["premultiply_dynamic_filter", "premultiply_filter", "unpremultiply_filter"]),
    ("shared_group_424", ["psnr_filter", "xpsnr_filter"]),
    ("shared_group_425", ["qrencode_filter", "qrencodesrc_filter"]),
    ("shared_group_426", ["removelogo_filter", "showcqt_filter"]),
    ("shared_group_427", ["scale2ref_filter", "scale_cuda_filter", "scale_d3d11_filter", "scale_d3d12_filter", "scale_filter", "scale_vaapi_filter", "scale_vt_filter", "sr_amf_filter", "vpp_amf_filter"]),
    ("shared_group_428", ["scale2ref_filter", "scale_filter"]),
    ("shared_group_429", ["setdar_filter", "setsar_filter"]),
    ("shared_group_43", ["acelp_kelvin_decoder", "amrnb_decoder", "amrwb_decoder", "comfortnoise_decoder", "g723_1_decoder", "g723_1_encoder", "g728_decoder", "g729_decoder", "qcelp_decoder", "ra_144_decoder", "ra_144_encoder", "ra_288_decoder", "sipr_decoder", "wmavoice_decoder"]),
    ("shared_group_430", ["setfield_filter", "setparams_filter", "setrange_filter"]),
    ("shared_group_431", ["showspectrum_filter", "showspectrumpic_filter"]),
    ("shared_group_432", ["showwaves_filter", "showwavespic_filter"]),
    ("shared_group_433", ["tmedian_filter", "xmedian_filter"]),
    ("shared_group_434", ["vidstabdetect_filter", "vidstabtransform_filter"]),
    ("shared_group_435", ["convolution_filter", "sobel_filter"]),
    ("shared_group_436", ["haldclut_filter", "lut3d_filter"]),
    ("shared_group_437", ["alsa_indev", "alsa_outdev"]),
    ("shared_group_438", ["alsa_indev", "jack_indev", "pulse_indev", "v4l2_indev"]),
    ("shared_group_439", ["fbdev_indev", "fbdev_outdev"]),
    ("shared_group_44", ["acelp_kelvin_decoder", "amrnb_decoder", "amrwb_decoder", "evrc_decoder", "g723_1_decoder", "g723_1_encoder", "g729_decoder", "qcelp_decoder", "sipr_decoder", "wmavoice_decoder"]),
    ("shared_group_440", ["oss_indev", "oss_outdev"]),
    ("shared_group_441", ["pulse_indev", "pulse_outdev"]),
    ("shared_group_442", ["sndio_indev", "sndio_outdev"]),
    ("shared_group_443", ["v4l2_indev", "v4l2_outdev"]),
    ("shared_group_45", ["acelp_kelvin_decoder", "amrnb_decoder", "amrwb_decoder", "g729_decoder", "qcelp_decoder", "sipr_decoder", "wmavoice_decoder"]),
    ("shared_group_46", ["acelp_kelvin_decoder", "amrnb_decoder", "amrwb_decoder", "g729_decoder", "sipr_decoder"]),
    ("shared_group_47", ["acelp_kelvin_decoder", "g729_decoder"]),
    ("shared_group_48", ["adpcm_4xm_decoder", "adpcm_afc_decoder", "adpcm_agm_decoder", "adpcm_aica_decoder", "adpcm_argo_decoder", "adpcm_argo_encoder", "adpcm_circus_decoder", "adpcm_ct_decoder", "adpcm_dtk_decoder", "adpcm_ea_decoder", "adpcm_ea_maxis_xa_decoder", "adpcm_ea_r1_decoder", "adpcm_ea_r2_decoder", "adpcm_ea_r3_decoder", "adpcm_ea_xas_decoder", "adpcm_ima_acorn_decoder", "adpcm_ima_alp_decoder", "adpcm_ima_alp_encoder", "adpcm_ima_amv_decoder", "adpcm_ima_amv_encoder", "adpcm_ima_apc_decoder", "adpcm_ima_apm_decoder", "adpcm_ima_apm_encoder", "adpcm_ima_cunning_decoder", "adpcm_ima_dat4_decoder", "adpcm_ima_dk3_decoder", "adpcm_ima_dk4_decoder", "adpcm_ima_ea_eacs_decoder", "adpcm_ima_ea_sead_decoder", "adpcm_ima_escape_decoder", "adpcm_ima_hvqm2_decoder", "adpcm_ima_hvqm4_decoder", "adpcm_ima_iss_decoder", "adpcm_ima_magix_decoder", "adpcm_ima_moflex_decoder", "adpcm_ima_mtf_decoder", "adpcm_ima_oki_decoder", "adpcm_ima_pda_decoder", "adpcm_ima_qt_decoder", "adpcm_ima_qt_encoder", "adpcm_ima_rad_decoder", "adpcm_ima_smjpeg_decoder", "adpcm_ima_ssi_decoder", "adpcm_ima_ssi_encoder", "adpcm_ima_wav_decoder", "adpcm_ima_wav_encoder", "adpcm_ima_ws_decoder", "adpcm_ima_ws_encoder", "adpcm_ima_xbox_decoder", "adpcm_ms_decoder", "adpcm_ms_encoder", "adpcm_mtaf_decoder", "adpcm_n64_decoder", "adpcm_psx_decoder", "adpcm_psxc_decoder", "adpcm_sanyo_decoder", "adpcm_sbpro_2_decoder", "adpcm_sbpro_3_decoder", "adpcm_sbpro_4_decoder", "adpcm_swf_decoder", "adpcm_swf_encoder", "adpcm_thp_decoder", "adpcm_thp_le_decoder", "adpcm_vima_decoder", "adpcm_xa_decoder", "adpcm_xmd_decoder", "adpcm_yamaha_decoder", "adpcm_yamaha_encoder", "adpcm_zork_decoder"]),
    ("shared_group_49", ["adpcm_4xm_decoder", "adpcm_afc_decoder", "adpcm_agm_decoder", "adpcm_aica_decoder", "adpcm_argo_decoder", "adpcm_argo_encoder", "adpcm_circus_decoder", "adpcm_ct_decoder", "adpcm_dtk_decoder", "adpcm_ea_decoder", "adpcm_ea_maxis_xa_decoder", "adpcm_ea_r1_decoder", "adpcm_ea_r2_decoder", "adpcm_ea_r3_decoder", "adpcm_ea_xas_decoder", "adpcm_ima_acorn_decoder", "adpcm_ima_alp_decoder", "adpcm_ima_amv_decoder", "adpcm_ima_apc_decoder", "adpcm_ima_apm_decoder", "adpcm_ima_cunning_decoder", "adpcm_ima_dat4_decoder", "adpcm_ima_dk3_decoder", "adpcm_ima_dk4_decoder", "adpcm_ima_ea_eacs_decoder", "adpcm_ima_ea_sead_decoder", "adpcm_ima_escape_decoder", "adpcm_ima_hvqm2_decoder", "adpcm_ima_hvqm4_decoder", "adpcm_ima_iss_decoder", "adpcm_ima_magix_decoder", "adpcm_ima_moflex_decoder", "adpcm_ima_mtf_decoder", "adpcm_ima_oki_decoder", "adpcm_ima_pda_decoder", "adpcm_ima_qt_decoder", "adpcm_ima_rad_decoder", "adpcm_ima_smjpeg_decoder", "adpcm_ima_ssi_decoder", "adpcm_ima_wav_decoder", "adpcm_ima_ws_decoder", "adpcm_ima_xbox_decoder", "adpcm_ms_decoder", "adpcm_mtaf_decoder", "adpcm_n64_decoder", "adpcm_psx_decoder", "adpcm_psxc_decoder", "adpcm_sanyo_decoder", "adpcm_sbpro_2_decoder", "adpcm_sbpro_3_decoder", "adpcm_sbpro_4_decoder", "adpcm_swf_decoder", "adpcm_thp_decoder", "adpcm_thp_le_decoder", "adpcm_vima_decoder", "adpcm_xa_decoder", "adpcm_xmd_decoder", "adpcm_yamaha_decoder", "adpcm_zork_decoder"]),
    ("shared_group_5", ["agm_decoder", "lead_decoder", "mss34dsp", "nuv_decoder", "vp3_decoder"]),
    ("shared_group_50", ["adpcm_adx_decoder", "adpcm_adx_encoder"]),
    ("shared_group_51", ["adpcm_argo_encoder", "adpcm_ima_alp_encoder", "adpcm_ima_amv_encoder", "adpcm_ima_apm_encoder", "adpcm_ima_qt_encoder", "adpcm_ima_ssi_encoder", "adpcm_ima_wav_encoder", "adpcm_ima_ws_encoder", "adpcm_ms_encoder", "adpcm_swf_encoder", "adpcm_yamaha_encoder"]),
    ("shared_group_52", ["adpcm_g722_decoder", "adpcm_g722_encoder"]),
    ("shared_group_53", ["adpcm_g726_decoder", "adpcm_g726_encoder", "adpcm_g726le_decoder", "adpcm_g726le_encoder"]),
    ("shared_group_54", ["ahx_decoder", "mp1float_decoder", "mp2float_decoder", "mp3adufloat_decoder", "mp3float_decoder", "mp3on4float_decoder"]),
    ("shared_group_55", ["alac_decoder", "alac_encoder"]),
    ("shared_group_56", ["amv_encoder", "ljpeg_encoder", "mjpeg_encoder"]),
    ("shared_group_57", ["amv_encoder", "mjpeg_encoder"]),
    ("shared_group_58", ["ansi_decoder", "bintext_decoder", "idf_decoder", "pictor_decoder", "tmv_decoder", "xbin_decoder"]),
    ("shared_group_59", ["anull_decoder", "anull_encoder", "vnull_decoder", "vnull_encoder"]),
    ("shared_group_6", ["asv1_decoder", "asv1_encoder", "asv2_decoder", "asv2_encoder", "eamad_decoder", "eatqi_decoder", "ipu_decoder", "mdec_decoder", "mpeg1video_decoder", "mpeg2video_decoder", "mpegvideo_decoder", "mpegvideo_parser", "mpegvideoenc", "speedhq_decoder", "speedhq_encoder"]),
    ("shared_group_60", ["apng_decoder", "apng_encoder", "lscr_decoder", "png_decoder", "png_encoder"]),
    ("shared_group_61", ["apng_decoder", "lscr_decoder", "png_decoder"]),
    ("shared_group_62", ["apng_encoder", "png_encoder"]),
    ("shared_group_63", ["aptx_decoder", "aptx_encoder", "aptx_hd_decoder", "aptx_hd_encoder"]),
    ("shared_group_64", ["aptx_decoder", "aptx_hd_decoder"]),
    ("shared_group_65", ["aptx_encoder", "aptx_hd_encoder"]),
    ("shared_group_66", ["apv_vulkan_hwaccel", "av1_vulkan_hwaccel", "dpx_vulkan_hwaccel", "ffv1_vulkan_hwaccel", "h264_vulkan_hwaccel", "hevc_vulkan_hwaccel", "prores_raw_vulkan_hwaccel", "prores_vulkan_hwaccel", "vp9_vulkan_hwaccel"]),
    ("shared_group_67", ["ass_decoder", "ass_encoder", "ccaption_decoder", "jacosub_decoder", "libaribb24_decoder", "libaribcaption_decoder", "libzvbi_teletext_decoder", "microdvd_decoder", "movtext_decoder", "mpl2_decoder", "pjs_decoder", "realtext_decoder", "sami_decoder", "srt_decoder", "ssa_decoder", "ssa_encoder", "stl_decoder", "subrip_decoder", "subviewer1_decoder", "subviewer_decoder", "text_decoder", "vplayer_decoder", "webvtt_decoder"]),
    ("shared_group_68", ["ass_decoder", "ssa_decoder"]),
    ("shared_group_69", ["ass_encoder", "ssa_encoder"]),
    ("shared_group_7", ["av1_vulkan_encoder", "d3d12va_encode", "h264_vulkan_encoder", "hevc_vulkan_encoder", "vaapi_encode"]),
    ("shared_group_70", ["asv1_decoder", "asv1_encoder", "asv2_decoder", "asv2_encoder"]),
    ("shared_group_71", ["asv1_decoder", "asv2_decoder"]),
    ("shared_group_72", ["asv1_encoder", "asv2_encoder"]),
    ("shared_group_73", ["atrac1_decoder", "atrac3_decoder", "atrac3al_decoder", "atrac3p_decoder", "atrac3pal_decoder"]),
    ("shared_group_74", ["atrac3_decoder", "atrac3al_decoder"]),
    ("shared_group_75", ["atrac3p_decoder", "atrac3pal_decoder"]),
    ("shared_group_76", ["aura_decoder", "cyuv_decoder"]),
    ("shared_group_77", ["av1_amf_decoder", "h264_amf_decoder", "hevc_amf_decoder", "vp9_amf_decoder"]),
    ("shared_group_78", ["av1_cuvid_decoder", "h264_cuvid_decoder", "hevc_cuvid_decoder", "mjpeg_cuvid_decoder", "mpeg1_cuvid_decoder", "mpeg2_cuvid_decoder", "mpeg4_cuvid_decoder", "vc1_cuvid_decoder", "vp8_cuvid_decoder", "vp9_cuvid_decoder"]),
    ("shared_group_79", ["av1_d3d11va_hwaccel", "av1_d3d12va_hwaccel", "av1_dxva2_hwaccel"]),
    ("shared_group_8", ["cbs_h264", "cbs_h265", "cbs_h266", "cbs_lcevc"]),
    ("shared_group_80", ["av1_d3d12va_encoder", "av1_vaapi_encoder", "av1_vulkan_encoder"]),
    ("shared_group_81", ["av1_decoder", "av1_parser", "extract_extradata_bsf", "libdav1d_decoder", "remove_extradata_bsf"]),
    ("shared_group_82", ["av1_mediacodec_encoder", "h264_mediacodec_encoder", "hevc_mediacodec_encoder", "mpeg4_mediacodec_encoder", "vp8_mediacodec_encoder", "vp9_mediacodec_encoder"]),
    ("shared_group_83", ["av1_nvenc_encoder", "h264_nvenc_encoder", "hevc_nvenc_encoder"]),
    ("shared_group_84", ["avrp_decoder", "r10k_decoder", "r210_decoder"]),
    ("shared_group_85", ["avrp_encoder", "r10k_encoder", "r210_encoder"]),
    ("shared_group_86", ["binkaudio_dct_decoder", "binkaudio_rdft_decoder"]),
    ("shared_group_87", ["bintext_decoder", "idf_decoder", "xbin_decoder"]),
    ("shared_group_88", ["cbd2_dpcm_decoder", "derf_dpcm_decoder", "gremlin_dpcm_decoder", "interplay_dpcm_decoder", "roq_dpcm_decoder", "sdx2_dpcm_decoder", "sol_dpcm_decoder", "wady_dpcm_decoder", "xan_dpcm_decoder"]),
    ("shared_group_89", ["cfhd_decoder", "cfhd_encoder"]),
    ("shared_group_9", ["cbs_vp8", "vp7_decoder", "vp8_decoder"]),
    ("shared_group_90", ["cllc_decoder", "hq_hqa_decoder", "hqx_decoder"]),
    ("shared_group_91", ["dca_decoder", "dca_encoder"]),
    ("shared_group_92", ["dca_decoder", "dca_parser"]),
    ("shared_group_93", ["dca_decoder", "dca_parser", "spdif_muxer"]),
    ("shared_group_94", ["dirac_decoder", "vc2_encoder"]),
    ("shared_group_95", ["dnxhd_decoder", "dnxhd_encoder", "dnxhd_parser"]),
    ("shared_group_96", ["dolby_e_decoder", "dolby_e_parser"]),
    ("shared_group_97", ["dsd_lsbf_decoder", "dsd_lsbf_planar_decoder", "dsd_msbf_decoder", "dsd_msbf_planar_decoder"]),
    ("shared_group_98", ["dsd_lsbf_decoder", "dsd_lsbf_planar_decoder", "dsd_msbf_decoder", "dsd_msbf_planar_decoder", "dst_decoder", "wavpack_decoder"]),
    ("shared_group_99", ["dvdsub_decoder", "dvdsub_encoder"]),
]
