...
FFMPEG_CONFIG_CHECKS = [
    ...
    checks.AC_TRY_COMPILE(name = "ac_cv_arm_crc_inline", define = "HAVE_ARM_CRC_INLINE", code = "#if !defined(__aarch64__)\n#error wrong arch\n#endif\nvoid foo(void){ __asm__ volatile(\"crc32x w0, w0, x0\"); }"),
    checks.AC_TRY_COMPILE(define = "HAVE_ARM_CRC_EXTERNAL", code = "#if !defined(__aarch64__)\n#error wrong arch\n#endif\nvoid foo(void){ __asm__ volatile(\"crc32x w0, w0, x0\"); }"),
    checks.AC_DEFINE("HAVE_ARM_CRC", condition = "ac_cv_arm_crc_inline", if_true = "1", if_false = "0"),
    checks.AC_TRY_COMPILE(name = "ac_cv_pmull_inline", define = "HAVE_PMULL_INLINE", code = "#if !defined(__aarch64__)\n#error wrong arch\n#endif\nvoid foo(void){ __asm__ volatile(\"pmull v0.1q, v0.1d, v0.1d\"); }"),
    checks.AC_TRY_COMPILE(define = "HAVE_PMULL_EXTERNAL", code = "#if !defined(__aarch64__)\n#error wrong arch\n#endif\nvoid foo(void){ __asm__ volatile(\"pmull v0.1q, v0.1d, v0.1d\"); }"),
    checks.AC_DEFINE("HAVE_PMULL", condition = "ac_cv_pmull_inline", if_true = "1", if_false = "0"),
    checks.AC_TRY_COMPILE(name = "ac_cv_eor3_inline", define = "HAVE_EOR3_INLINE", code = "#if !defined(__aarch64__)\n#error wrong arch\n#endif\nvoid foo(void){ __asm__ volatile(\"eor3 v0.16b, v1.16b, v2.16b, v3.16b\"); }"),
    checks.AC_TRY_COMPILE(define = "HAVE_EOR3_EXTERNAL", code = "#if !defined(__aarch64__)\n#error wrong arch\n#endif\nvoid foo(void){ __asm__ volatile(\"eor3 v0.16b, v1.16b, v2.16b, v3.16b\"); }"),
    ...
    checks.AC_TRY_COMPILE(name = "ac_cv_clmul_inline", define = "HAVE_CLMUL_INLINE", code = "#if !(defined(__i386__) || defined(__x86_64__))\n#error wrong arch\n#endif\nvoid foo(void){ __asm__ volatile(\"pclmulqdq $0, %xmm0, %xmm0\"); }"),
    checks.AC_TRY_COMPILE(define = "HAVE_CLMUL_EXTERNAL", code = "#if !(defined(__i386__) || defined(__x86_64__))\n#error wrong arch\n#endif\nvoid foo(void){ __asm__ volatile(\"pclmulqdq $0, %xmm0, %xmm0\"); }"),
    checks.AC_DEFINE("HAVE_CLMUL", condition = "ac_cv_clmul_inline", if_true = "1", if_false = "0"),
