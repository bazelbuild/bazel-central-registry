...
AVCODEC_EXTRA_SHARED_SRCS = [
    ...
    (("cbs_h264", "cbs_h265", "cbs_h266", "extract_extradata_bsf", "h264parse", "hevcparse"), ["libavcodec/h2645_parse.c"]),
...
EXTRA_SHARED_GROUP_DEFINITIONS = [
    ...
    ("extra_shared_group_3", ["cbs_h264", "cbs_h265", "cbs_h266", "extract_extradata_bsf", "h264parse", "hevcparse"]),
