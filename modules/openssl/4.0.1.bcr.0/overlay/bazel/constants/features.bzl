...
FEATURE_DEFINES = select({
    "//configs:allocfail_tests_disabled": ["-DOPENSSL_NO_ALLOCFAIL_TESTS"],
    "//conditions:default": [],
}) + \
    select({
    ...
    select({
    "//configs:ec_explicit_curves_disabled": ["-DOPENSSL_NO_EC_EXPLICIT_CURVES"],
    "//conditions:default": [],
}) + \
    select({
    ...
    select({
    "//configs:ech_disabled": ["-DOPENSSL_NO_ECH"],
    "//conditions:default": [],
}) + \
    select({
    ...
    select({
    "//configs:hmac_drbg_kdf_disabled": ["-DOPENSSL_NO_HMAC_DRBG_KDF"],
    "//conditions:default": [],
}) + \
    select({
    ...
    select({
    "//configs:kbkdf_disabled": ["-DOPENSSL_NO_KBKDF"],
    "//conditions:default": [],
}) + \
    select({
    "//configs:krb5kdf_disabled": ["-DOPENSSL_NO_KRB5KDF"],
    "//conditions:default": [],
}) + \
    select({
    ...
    select({
    "//configs:lms_disabled": ["-DOPENSSL_NO_LMS"],
    "//conditions:default": [],
}) + \
    select({
    ...
    select({
    "//configs:pvkkdf_disabled": ["-DOPENSSL_NO_PVKKDF"],
    "//conditions:default": [],
}) + \
    select({
    ...
    select({
    "//configs:snmpkdf_disabled": ["-DOPENSSL_NO_SNMPKDF"],
    "//conditions:default": [],
}) + \
    select({
    ...
    select({
    "//configs:srtpkdf_disabled": ["-DOPENSSL_NO_SRTPKDF"],
    "//conditions:default": [],
}) + \
    select({
    "//configs:sshkdf_disabled": ["-DOPENSSL_NO_SSHKDF"],
    "//conditions:default": [],
}) + \
    select({
    "//configs:sskdf_disabled": ["-DOPENSSL_NO_SSKDF"],
    "//conditions:default": [],
}) + \
    select({
    ...
    select({
    "//configs:static_vcruntime_disabled": ["-DOPENSSL_NO_STATIC_VCRUNTIME"],
    "//conditions:default": [],
}) + \
    select({
    ...
    select({
    "//configs:x942kdf_disabled": ["-DOPENSSL_NO_X942KDF"],
    "//conditions:default": [],
}) + \
    select({
    "//configs:x963kdf_disabled": ["-DOPENSSL_NO_X963KDF"],
    "//conditions:default": [],
}) + \
    select({
...
def openssl_feature_flags():
    bool_flag(name = "no-allocfail-tests", build_setting_default = False, visibility = ["//visibility:public"])
    ...
    bool_flag(name = "no-ec_explicit_curves", build_setting_default = False, visibility = ["//visibility:public"])
    ...
    bool_flag(name = "no-ech", build_setting_default = False, visibility = ["//visibility:public"])
    ...
    bool_flag(name = "no-hmac-drbg-kdf", build_setting_default = False, visibility = ["//visibility:public"])
    ...
    bool_flag(name = "no-kbkdf", build_setting_default = False, visibility = ["//visibility:public"])
    bool_flag(name = "no-krb5kdf", build_setting_default = False, visibility = ["//visibility:public"])
    bool_flag(name = "no-ktls", build_setting_default = False, visibility = ["//visibility:public"])
    bool_flag(name = "no-lms", build_setting_default = False, visibility = ["//visibility:public"])
    ...
    bool_flag(name = "no-pvkkdf", build_setting_default = False, visibility = ["//visibility:public"])
    ...
    bool_flag(name = "no-snmpkdf", build_setting_default = False, visibility = ["//visibility:public"])
    ...
    bool_flag(name = "no-srtpkdf", build_setting_default = False, visibility = ["//visibility:public"])
    bool_flag(name = "no-sshkdf", build_setting_default = False, visibility = ["//visibility:public"])
    bool_flag(name = "no-sskdf", build_setting_default = False, visibility = ["//visibility:public"])
    ...
    bool_flag(name = "no-static-vcruntime", build_setting_default = False, visibility = ["//visibility:public"])
    ...
    bool_flag(name = "no-x942kdf", build_setting_default = False, visibility = ["//visibility:public"])
    bool_flag(name = "no-x963kdf", build_setting_default = False, visibility = ["//visibility:public"])
...
def openssl_feature_config_settings():
    native.config_setting(
        name = "allocfail_tests_disabled",
        flag_values = {"//:no-allocfail-tests": "True"},
    ...
    native.config_setting(
        name = "ec_explicit_curves_disabled",
        flag_values = {"//:no-ec_explicit_curves": "True"},
        visibility = ["//visibility:public"],
    )
    native.config_setting(
    ...
    native.config_setting(
        name = "hmac_drbg_kdf_disabled",
        flag_values = {"//:no-hmac-drbg-kdf": "True"},
        visibility = ["//visibility:public"],
    )
    native.config_setting(
    ...
    native.config_setting(
        name = "kbkdf_disabled",
        flag_values = {"//:no-kbkdf": "True"},
        visibility = ["//visibility:public"],
    )
    native.config_setting(
        name = "krb5kdf_disabled",
        flag_values = {"//:no-krb5kdf": "True"},
        visibility = ["//visibility:public"],
    )
    native.config_setting(
        name = "ktls_disabled",
    ...
    native.config_setting(
        name = "pvkkdf_disabled",
        flag_values = {"//:no-pvkkdf": "True"},
        visibility = ["//visibility:public"],
    )
    native.config_setting(
        name = "quic_disabled",
    ...
    native.config_setting(
        name = "snmpkdf_disabled",
        flag_values = {"//:no-snmpkdf": "True"},
        visibility = ["//visibility:public"],
    )
    native.config_setting(
        name = "sock_disabled",
    ...
    native.config_setting(
        name = "srtpkdf_disabled",
        flag_values = {"//:no-srtpkdf": "True"},
        visibility = ["//visibility:public"],
    )
    native.config_setting(
        name = "sshkdf_disabled",
        flag_values = {"//:no-sshkdf": "True"},
        visibility = ["//visibility:public"],
    )
    native.config_setting(
        name = "sskdf_disabled",
        flag_values = {"//:no-sskdf": "True"},
        visibility = ["//visibility:public"],
    )
    native.config_setting(
    ...
    native.config_setting(
        name = "static_vcruntime_disabled",
        flag_values = {"//:no-static-vcruntime": "True"},
        visibility = ["//visibility:public"],
    )
    native.config_setting(
        name = "tfo_disabled",
    ...
    native.config_setting(
        name = "x942kdf_disabled",
        flag_values = {"//:no-x942kdf": "True"},
        visibility = ["//visibility:public"],
    )
    native.config_setting(
        name = "x963kdf_disabled",
        flag_values = {"//:no-x963kdf": "True"},
        visibility = ["//visibility:public"],
    )
    native.config_setting(
