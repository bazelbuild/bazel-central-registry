...
PERLASM_GEN = "\n".join([
    "$(PERL) $(execpath crypto/aes/asm/aes-cfb-avx512.pl) elf $(execpath crypto/aes/aes-cfb-avx512.s);",
    ...
    "$(PERL) $(execpath crypto/sm3/asm/sm3-x86_64.pl) elf $(execpath crypto/sm3/sm3-x86_64.S);",
    "$(PERL) $(execpath crypto/sm4/asm/sm4-x86_64.pl) elf $(execpath crypto/sm4/sm4-x86_64.S);",
