...
PERLASM_GEN = "\n".join([
    "$(PERL) $(execpath crypto/aes/asm/aes-sha1-armv8.pl) ios64 $(execpath crypto/aes/aes-sha1-armv8.S);",
    "$(PERL) $(execpath crypto/aes/asm/aes-sha256-armv8.pl) ios64 $(execpath crypto/aes/aes-sha256-armv8.S);",
    "$(PERL) $(execpath crypto/aes/asm/aes-sha512-armv8.pl) ios64 $(execpath crypto/aes/aes-sha512-armv8.S);",
    ...
    "$(PERL) $(execpath crypto/poly1305/asm/poly1305-armv9-sve2.pl) ios64 $(execpath crypto/poly1305/poly1305-armv9-sve2.S);",
