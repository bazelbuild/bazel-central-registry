...
our %config = (
    ...
    openssl_api_defines     => ["OPENSSL_CONFIGURED_API=40000"],
...
our @disablables = qw(acvp-tests apps argon2 aria asan asm async atexit autoalginit autoerrinit autoload-config bf blake2 brotli brotli-dynamic buildtest-c++ bulk cached-fetch camellia winstore cast chacha cmac cmp cms comp crypto-mdebug allocfail-tests ct default-thread-pool demos h3demo hqinterop hmac-drbg-kdf deprecated des dgram dh docs dsa dso dtls ec ec2m ec_explicit_curves ec_nistp_64_gcc_128 ecdh ecdsa ecx ech egd err external-tests filenames fips fips-securitychecks fips-post fips-jitter fuzz-afl fuzz-libfuzzer gost http idea integrity-only-ciphers jitter kbkdf krb5kdf ktls legacy lms makedepend md2 md4 mdc2 ml-dsa ml-kem module msan multiblock nextprotoneg ocb ocsp pic pie pinshared poly1305 posix-io psk pvkkdf quic unstable-qlog rc2 rc4 rc5 rdrand rfc3779 rmd160 scrypt sctp secure-memory seed shared siphash siv slh-dsa sm2 sm2-precomp sm3 sm4 snmpkdf sock srp srtp srtpkdf sse2 sshkdf sskdf ssl-trace static-vcruntime stdio sslkeylog tests tfo thread-pool threads tls tls-deprecated-ec trace ts ubsan ui-console unit-test uplink weak-ssl-ciphers whirlpool x942kdf x963kdf zlib zlib-dynamic zstd zstd-dynamic tls1 tls1-method tls1_1 tls1_1-method tls1_2 tls1_2-method tls1_3 dtls1 dtls1-method dtls1_2 dtls1_2-method);
