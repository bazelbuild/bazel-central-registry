...
PERLASM_GEN = """
$(PERL) $(location crypto/aes/asm/aes-x86_64.pl) elf $(location crypto/aes/aes-x86_64.s);
$(PERL) $(location crypto/aes/asm/aesni-mb-x86_64.pl) elf $(location crypto/aes/aesni-mb-x86_64.s);
$(PERL) $(location crypto/aes/asm/aesni-sha1-x86_64.pl) elf $(location crypto/aes/aesni-sha1-x86_64.s);
$(PERL) $(location crypto/aes/asm/aesni-sha256-x86_64.pl) elf $(location crypto/aes/aesni-sha256-x86_64.s);
$(PERL) $(location crypto/aes/asm/aesni-x86_64.pl) elf $(location crypto/aes/aesni-x86_64.s);
$(PERL) $(location crypto/aes/asm/bsaes-x86_64.pl) elf $(location crypto/aes/bsaes-x86_64.s);
$(PERL) $(location crypto/aes/asm/vpaes-x86_64.pl) elf $(location crypto/aes/vpaes-x86_64.s);
$(PERL) $(location crypto/bn/asm/rsaz-2k-avx512.pl) elf $(location crypto/bn/rsaz-2k-avx512.s);
$(PERL) $(location crypto/bn/asm/rsaz-3k-avx512.pl) elf $(location crypto/bn/rsaz-3k-avx512.s);
$(PERL) $(location crypto/bn/asm/rsaz-4k-avx512.pl) elf $(location crypto/bn/rsaz-4k-avx512.s);
$(PERL) $(location crypto/bn/asm/rsaz-avx2.pl) elf $(location crypto/bn/rsaz-avx2.s);
$(PERL) $(location crypto/bn/asm/rsaz-x86_64.pl) elf $(location crypto/bn/rsaz-x86_64.s);
$(PERL) $(location crypto/bn/asm/x86_64-gf2m.pl) elf $(location crypto/bn/x86_64-gf2m.s);
$(PERL) $(location crypto/bn/asm/x86_64-mont.pl) elf $(location crypto/bn/x86_64-mont.s);
$(PERL) $(location crypto/bn/asm/x86_64-mont5.pl) elf $(location crypto/bn/x86_64-mont5.s);
$(PERL) $(location crypto/camellia/asm/cmll-x86_64.pl) elf $(location crypto/camellia/cmll-x86_64.s);
$(PERL) $(location crypto/chacha/asm/chacha-x86_64.pl) elf $(location crypto/chacha/chacha-x86_64.s);
$(PERL) $(location crypto/ec/asm/ecp_nistz256-x86_64.pl) elf $(location crypto/ec/ecp_nistz256-x86_64.s);
$(PERL) $(location crypto/ec/asm/x25519-x86_64.pl) elf $(location crypto/ec/x25519-x86_64.s);
$(PERL) $(location crypto/md5/asm/md5-x86_64.pl) elf $(location crypto/md5/md5-x86_64.s);
$(PERL) $(location crypto/modes/asm/aes-gcm-avx512.pl) elf $(location crypto/modes/aes-gcm-avx512.s);
$(PERL) $(location crypto/modes/asm/aesni-gcm-x86_64.pl) elf $(location crypto/modes/aesni-gcm-x86_64.s);
$(PERL) $(location crypto/modes/asm/ghash-x86_64.pl) elf $(location crypto/modes/ghash-x86_64.s);
$(PERL) $(location crypto/poly1305/asm/poly1305-x86_64.pl) elf $(location crypto/poly1305/poly1305-x86_64.s);
$(PERL) $(location crypto/rc4/asm/rc4-md5-x86_64.pl) elf $(location crypto/rc4/rc4-md5-x86_64.s);
$(PERL) $(location crypto/rc4/asm/rc4-x86_64.pl) elf $(location crypto/rc4/rc4-x86_64.s);
$(PERL) $(location crypto/sha/asm/keccak1600-x86_64.pl) elf $(location crypto/sha/keccak1600-x86_64.s);
$(PERL) $(location crypto/sha/asm/sha1-mb-x86_64.pl) elf $(location crypto/sha/sha1-mb-x86_64.s);
$(PERL) $(location crypto/sha/asm/sha1-x86_64.pl) elf $(location crypto/sha/sha1-x86_64.s);
$(PERL) $(location crypto/sha/asm/sha256-mb-x86_64.pl) elf $(location crypto/sha/sha256-mb-x86_64.s);
$(PERL) $(location crypto/sha/asm/sha512-x86_64.pl) elf $(location crypto/sha/sha256-x86_64.s);
$(PERL) $(location crypto/sha/asm/sha512-x86_64.pl) elf $(location crypto/sha/sha512-x86_64.s);
$(PERL) $(location crypto/whrlpool/asm/wp-x86_64.pl) elf $(location crypto/whrlpool/wp-x86_64.s);
$(PERL) $(location crypto/x86_64cpuid.pl) elf $(location crypto/x86_64cpuid.s);
$(PERL) $(location engines/asm/e_padlock-x86_64.pl) elf $(location engines/e_padlock-x86_64.s);
"""
