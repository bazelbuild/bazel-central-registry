...
PERLASM_GEN = """
$(PERL) $(location crypto/aes/asm/aesv8-armx.pl) ios64 $(location crypto/aes/aesv8-armx.S);
$(PERL) $(location crypto/aes/asm/bsaes-armv8.pl) ios64 $(location crypto/aes/bsaes-armv8.S);
$(PERL) $(location crypto/aes/asm/vpaes-armv8.pl) ios64 $(location crypto/aes/vpaes-armv8.S);
$(PERL) $(location crypto/arm64cpuid.pl) ios64 $(location crypto/arm64cpuid.S);
$(PERL) $(location crypto/bn/asm/armv8-mont.pl) ios64 $(location crypto/bn/armv8-mont.S);
$(PERL) $(location crypto/chacha/asm/chacha-armv8-sve.pl) ios64 $(location crypto/chacha/chacha-armv8-sve.S);
$(PERL) $(location crypto/chacha/asm/chacha-armv8.pl) ios64 $(location crypto/chacha/chacha-armv8.S);
$(PERL) $(location crypto/ec/asm/ecp_nistz256-armv8.pl) ios64 $(location crypto/ec/ecp_nistz256-armv8.S);
$(PERL) $(location crypto/ec/asm/ecp_sm2p256-armv8.pl) ios64 $(location crypto/ec/ecp_sm2p256-armv8.S);
$(PERL) $(location crypto/md5/asm/md5-aarch64.pl) ios64 $(location crypto/md5/md5-aarch64.S);
$(PERL) $(location crypto/modes/asm/aes-gcm-armv8-unroll8_64.pl) ios64 $(location crypto/modes/aes-gcm-armv8-unroll8_64.S);
$(PERL) $(location crypto/modes/asm/aes-gcm-armv8_64.pl) ios64 $(location crypto/modes/aes-gcm-armv8_64.S);
$(PERL) $(location crypto/modes/asm/ghashv8-armx.pl) ios64 $(location crypto/modes/ghashv8-armx.S);
$(PERL) $(location crypto/poly1305/asm/poly1305-armv8.pl) ios64 $(location crypto/poly1305/poly1305-armv8.S);
$(PERL) $(location crypto/sha/asm/keccak1600-armv8.pl) ios64 $(location crypto/sha/keccak1600-armv8.S);
$(PERL) $(location crypto/sha/asm/sha1-armv8.pl) ios64 $(location crypto/sha/sha1-armv8.S);
$(PERL) $(location crypto/sha/asm/sha512-armv8.pl) ios64 $(location crypto/sha/sha256-armv8.S);
$(PERL) $(location crypto/sha/asm/sha512-armv8.pl) ios64 $(location crypto/sha/sha512-armv8.S);
$(PERL) $(location crypto/sm3/asm/sm3-armv8.pl) ios64 $(location crypto/sm3/sm3-armv8.S);
$(PERL) $(location crypto/sm4/asm/sm4-armv8.pl) ios64 $(location crypto/sm4/sm4-armv8.S);
$(PERL) $(location crypto/sm4/asm/vpsm4-armv8.pl) ios64 $(location crypto/sm4/vpsm4-armv8.S);
$(PERL) $(location crypto/sm4/asm/vpsm4_ex-armv8.pl) ios64 $(location crypto/sm4/vpsm4_ex-armv8.S);
"""
